...
/*    */ {
/* 13 */   private static String _id = "IDL:omg.org/PortableInterceptor/ORBInitInfo/InvalidName:1.0";
/*    */ 
...
/* 19 */     write(localOutputStream, paramInvalidName);
...
/* 45 */           __typeCode = ORB.init().create_exception_tc(id(), "InvalidName", arrayOfStructMember);
/* 46 */           __active = false;
/*    */         }
/*    */       }
/*    */     }
...
/*    */   {
/* 60 */     InvalidName localInvalidName = new InvalidName();
/*    */ 
/* 62 */     paramInputStream.read_string();
/* 63 */     return localInvalidName;
/*    */   }
/*    */ 
 ...
 * Qualified Name:     org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidNameHelper
