...
/*    */ {
/* 13 */   private static String _id = "IDL:omg.org/PortableInterceptor/InvalidSlot:1.0";
/*    */ 
...
/* 19 */     write(localOutputStream, paramInvalidSlot);
...
/* 45 */           __typeCode = ORB.init().create_exception_tc(id(), "InvalidSlot", arrayOfStructMember);
/* 46 */           __active = false;
/*    */         }
/*    */       }
/*    */     }
...
/*    */   {
/* 60 */     InvalidSlot localInvalidSlot = new InvalidSlot();
/*    */ 
/* 62 */     paramInputStream.read_string();
/* 63 */     return localInvalidSlot;
/*    */   }
/*    */ 
 ...
 * Qualified Name:     org.omg.PortableInterceptor.InvalidSlotHelper
