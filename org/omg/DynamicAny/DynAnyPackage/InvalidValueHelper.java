...
/*    */ {
/* 13 */   private static String _id = "IDL:omg.org/DynamicAny/DynAny/InvalidValue:1.0";
/*    */ 
...
/* 19 */     write(localOutputStream, paramInvalidValue);
...
/* 45 */           __typeCode = ORB.init().create_exception_tc(id(), "InvalidValue", arrayOfStructMember);
/* 46 */           __active = false;
/*    */         }
/*    */       }
/*    */     }
...
/*    */   {
/* 60 */     InvalidValue localInvalidValue = new InvalidValue();
/*    */ 
/* 62 */     paramInputStream.read_string();
/* 63 */     return localInvalidValue;
/*    */   }
/*    */ 
 ...
 * Qualified Name:     org.omg.DynamicAny.DynAnyPackage.InvalidValueHelper
