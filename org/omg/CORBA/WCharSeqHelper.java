...
/*    */ {
/* 52 */   private static String _id = "IDL:omg.org/CORBA/WCharSeq:1.0";
/*    */ 
...
/*    */     {
/* 72 */       __typeCode = ORB.init().get_primitive_tc(TCKind.tk_wchar);
/* 73 */       __typeCode = ORB.init().create_sequence_tc(0, __typeCode);
/* 74 */       __typeCode = ORB.init().create_alias_tc(id(), "WCharSeq", __typeCode);
/*    */     }
...
/* 89 */     paramInputStream.read_wchar_array(arrayOfChar, 0, i);
...
/* 96 */     paramOutputStream.write_wchar_array(paramArrayOfChar, 0, paramArrayOfChar.length);
/*    */   }
/*    */ }

/* Location:           C:\Program Files\Java\jdk1.7.0_79\jre\lib\rt.jar
 * Qualified Name:     org.omg.CORBA.WCharSeqHelper
