...
/*    */ {
/* 13 */   private static String _id = "IDL:omg.org/IOP/Codec/InvalidTypeForEncoding:1.0";
/*    */ 
...
/* 19 */     write(localOutputStream, paramInvalidTypeForEncoding);
...
/* 45 */           __typeCode = ORB.init().create_exception_tc(id(), "InvalidTypeForEncoding", arrayOfStructMember);
/* 46 */           __active = false;
/*    */         }
/*    */       }
/*    */     }
...
/*    */   {
/* 60 */     InvalidTypeForEncoding localInvalidTypeForEncoding = new InvalidTypeForEncoding();
/*    */ 
/* 62 */     paramInputStream.read_string();
/* 63 */     return localInvalidTypeForEncoding;
/*    */   }
/*    */ 
 ...
 * Qualified Name:     org.omg.IOP.CodecPackage.InvalidTypeForEncodingHelper
