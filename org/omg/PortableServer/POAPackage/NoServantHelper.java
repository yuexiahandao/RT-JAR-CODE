...
/*    */ {
/* 13 */   private static String _id = "IDL:omg.org/PortableServer/POA/NoServant:1.0";
/*    */ 
...
/* 19 */     write(localOutputStream, paramNoServant);
...
/* 45 */           __typeCode = ORB.init().create_exception_tc(id(), "NoServant", arrayOfStructMember);
/* 46 */           __active = false;
/*    */         }
/*    */       }
/*    */     }
...
/*    */   {
/* 60 */     NoServant localNoServant = new NoServant();
/*    */ 
/* 62 */     paramInputStream.read_string();
/* 63 */     return localNoServant;
/*    */   }
/*    */ 
 ...
 * Qualified Name:     org.omg.PortableServer.POAPackage.NoServantHelper
