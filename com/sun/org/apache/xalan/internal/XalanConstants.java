...
/* 228 */   public static final boolean IS_JDK8_OR_ABOVE = isJavaVersionAtLeast(8);
/*     */ 
/*     */   public static boolean isJavaVersionAtLeast(int compareTo)
/*     */   {
/* 243 */     String javaVersion = SecuritySupport.getSystemProperty("java.version");
/* 244 */     String[] versions = javaVersion.split("\\.", 3);
/* 245 */     if ((Integer.parseInt(versions[0]) >= compareTo) || (Integer.parseInt(versions[1]) >= compareTo))
/*     */     {
/* 247 */       return true;
/*     */     }
/* 249 */     return false;
 ...
 * Qualified Name:     com.sun.org.apache.xalan.internal.XalanConstants
