...
/*     */   public static final String JDK_GENEAL_ENTITY_SIZE_LIMIT = "http://www.oracle.com/xml/jaxp/properties/maxGeneralEntitySizeLimit";
...
/* 695 */   private static final String[] fgSAXFeatures = { "namespaces", "namespace-prefixes", "string-interning", "validation", "external-general-entities", "external-parameter-entities" };
/*     */ 
/* 705 */   private static final String[] fgSAXProperties = { "declaration-handler", "lexical-handler", "dom-node", "xml-string" };
/*     */ 
...
/*     */   {
/* 903 */     print("SAX features:", "http://xml.org/sax/features/", fgSAXFeatures);
/* 904 */     print("SAX properties:", "http://xml.org/sax/properties/", fgSAXProperties);
/* 905 */     print("Xerces features:", "http://apache.org/xml/features/", fgXercesFeatures);
/* 906 */     print("Xerces properties:", "http://apache.org/xml/properties/", fgXercesProperties);
/*     */   }
/*     */ 
/*     */   private static void print(String header, String prefix, Object[] array)
/*     */   {
/* 912 */     System.out.print(header);
/* 913 */     if (array.length > 0) {
/* 914 */       System.out.println();
/* 915 */       for (int i = 0; i < array.length; i++) {
/* 916 */         System.out.print("  ");
/* 917 */         System.out.print(prefix);
/* 918 */         System.out.println(array[i]);
/*     */       }
/*     */     }
/*     */     else {
/* 922 */       System.out.println(" none.");
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/* 862 */       this.array = array;
/*     */     }
/*     */ 
/*     */     public boolean hasMoreElements()
/*     */     {
/* 877 */       return this.index < this.array.length;
/*     */     }
/*     */ 
/*     */     public Object nextElement()
/*     */     {
/* 888 */       if (this.index < this.array.length) {
/* 889 */         return this.array[(this.index++)];
/*     */       }
 ...
 * Qualified Name:     com.sun.org.apache.xerces.internal.impl.Constants
