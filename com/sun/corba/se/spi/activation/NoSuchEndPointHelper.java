...
/*    */ {
/* 13 */   private static String _id = "IDL:activation/NoSuchEndPoint:1.0";
/*    */ 
...
/* 19 */     write(localOutputStream, paramNoSuchEndPoint);
...
/* 45 */           __typeCode = ORB.init().create_exception_tc(id(), "NoSuchEndPoint", arrayOfStructMember);
/* 46 */           __active = false;
/*    */         }
/*    */       }
/*    */     }
...
/*    */   {
/* 60 */     NoSuchEndPoint localNoSuchEndPoint = new NoSuchEndPoint();
/*    */ 
/* 62 */     paramInputStream.read_string();
/* 63 */     return localNoSuchEndPoint;
/*    */   }
/*    */ 
 ...
 * Qualified Name:     com.sun.corba.se.spi.activation.NoSuchEndPointHelper
