...
/* 19 */     write(localOutputStream, paramBadServerDefinition);
...
/* 46 */           arrayOfStructMember[0] = new StructMember("reason", localTypeCode, null);
/*    */ 
...
/*    */   {
/* 65 */     BadServerDefinition localBadServerDefinition = new BadServerDefinition();
/*    */ 
/* 67 */     paramInputStream.read_string();
/* 68 */     localBadServerDefinition.reason = paramInputStream.read_string();
/* 69 */     return localBadServerDefinition;
/*    */   }
/*    */ 
 ...
 * Qualified Name:     com.sun.corba.se.spi.activation.BadServerDefinitionHelper
