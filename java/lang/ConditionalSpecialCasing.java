...
/*     */
        int i;
/* 211 */
        for (int j = paramInt; (j >= 0) && (!localBreakIterator.isBoundary(j));
/* 212 */       j -= Character.charCount(i))
/*     */ {
/* 214 */
            i = paramString.codePointBefore(j);
/* 215 */
            if (isCased(i))
/*     */ {
/* 217 */
...
/*     */ 
/* 221 */
                for (; (j < k) && (!localBreakIterator.isBoundary(j));
...
/*     */
        int i;
/* 250 */
        for (int k = paramInt; k > 0; k -= Character.charCount(i))
/*     */ {
/* 252 */
            i = paramString.codePointBefore(k);
/*     */ 
/* 254 */
            if (i == 73) {
/* 255 */
...
/*     */
        int i;
/* 315 */
        for (; m < k; m += Character.charCount(i))
/*     */ {
/* 317 */
...
/* 406 */
        ...
        if ((paramInt >= 9398) && (paramInt <= 9449))
/*     */ {
/* 409 */
            return true;
/*     */
...
/* 445 */
            this.ch = paramInt1;
/* 446 */
            this.lower = paramArrayOfChar1;
/* 447 */
            this.upper = paramArrayOfChar2;
/* 448 */
            this.lang = paramString;
/* 449 */
            this.condition = paramInt2;
/*     */
        }
