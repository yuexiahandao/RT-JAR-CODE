...
/*  241 */     int i = paramInt;
/*  242 */     int j = getProperties(paramInt);
/*      */ 
/*  244 */     if ((j & 0x10000) != 0) {
/*  245 */       if ((j & 0x7FC0000) == 133955584) {
/*  246 */         switch (paramInt) {
/*      */         case 181:
/*  248 */           i = 924; break;
/*      */         case 383:
...
/*  347 */     int i = paramInt;
/*  348 */     int j = getProperties(paramInt);
/*      */ 
/*  350 */     if ((j & 0x8000) != 0)
/*      */     {
/*  352 */       if ((j & 0x10000) == 0)
...
/*  355 */         i = paramInt + 1;
/*      */       }
/*  357 */       else if ((j & 0x20000) == 0)
/*      */       {
/*  360 */         i = paramInt - 1;
/*      */       }
/*      */ 
/*      */     }
/*  368 */     else if ((j & 0x10000) != 0)
/*      */     {
/*  371 */       i = toUpperCase(paramInt);
/*      */     }
/*  373 */     return i;
/*      */   }
/*      */ 
...
/*  377 */     int i = -1;
/*  378 */     if ((paramInt2 >= 2) && (paramInt2 <= 36)) {
/*  379 */       int j = getProperties(paramInt1);
/*  380 */       int k = j & 0x1F;
/*  381 */       if (k == 9) {
/*  382 */         i = paramInt1 + ((j & 0x3E0) >> 5) & 0x1F;
/*      */       }
/*  384 */       else if ((j & 0xC00) == 3072)
/*      */       {
/*  386 */         i = (paramInt1 + ((j & 0x3E0) >> 5) & 0x1F) + 10;
/*      */       }
/*      */     }
/*  389 */     return i < paramInt2 ? i : -1;
/*      */   }
/*      */ 
/*      */   int getNumericValue(int paramInt) {
/*  393 */     int i = getProperties(paramInt);
/*  394 */     int j = -1;
/*      */ 
/*  396 */     switch (i & 0xC00) {
/*      */     case 0:
...
/*  400 */       break;
/*      */     case 1024:
/*  402 */       j = paramInt + ((i & 0x3E0) >> 5) & 0x1F;
/*  403 */       break;
/*      */     case 2048:
/*  405 */       switch (paramInt) { case 3057:
/*  406 */         j = 100; break;
/*      */       case 3058:
/*  407 */         j = 1000; break;
/*      */       case 4981:
...
/*  456 */         j = -2; } break;
/*      */     case 3072:
/*  460 */       j = (paramInt + ((i & 0x3E0) >> 5) & 0x1F) + 10;
/*      */     }
/*      */ 
/*  463 */     return j;
/*      */   }
...
/*  467 */     int i = getProperties(paramInt);
/*  468 */     return (i & 0x7000) == 16384;
/*      */   }
/*      */ 
/*      */   byte getDirectionality(int paramInt) {
/*  472 */     int i = getProperties(paramInt);
/*  473 */     byte b = (byte)((i & 0x78000000) >> 27);
/*  474 */     if (b == 15) {
/*  475 */       switch (paramInt)
/*      */       {
/*      */       case 8234:
...
/*  505 */     int i = getProperties(paramInt);
/*  506 */     return (i & 0x80000000) != 0;
/*      */   }
/*      */ 
/*      */   int toUpperCaseEx(int paramInt) {
/*  510 */     int i = paramInt;
/*  511 */     int j = getProperties(paramInt);
/*      */ 
/*  513 */     if ((j & 0x10000) != 0) {
/*  514 */       if ((j & 0x7FC0000) != 133955584) {
/*  515 */         int k = j << 5 >> 23;
/*  516 */         i = paramInt - k;
/*      */       }
/*      */       else {
...
/*  584 */     char[] arrayOfChar = { (char)paramInt };
/*  585 */     int i = findInCharMap(paramInt);
/*  586 */     if (i != -1) {
/*  587 */       arrayOfChar = charMap[i][1];
/*      */     }
/*  589 */     return arrayOfChar;
/*      */   }
/*      */ 
/*      */   int findInCharMap(int paramInt)
/*      */   {
/*  601 */     if ((charMap == null) || (charMap.length == 0)) {
/*  602 */       return -1;
/*      */     }
/*      */ 
/*  605 */     int j = 0;
/*  606 */     int i = charMap.length;
/*  607 */     int k = i / 2;
/*      */ 
/*  609 */     while (i - j > 1) {
/*  610 */       if (paramInt >= charMap[k][0][0])
/*  611 */         j = k;
/*      */       else {
/*  613 */         i = k;
/*      */       }
/*  615 */       k = (i + j) / 2;
/*      */     }
/*  617 */     if (paramInt == charMap[k][0][0]) return k;
/*  618 */     return -1;
/*      */   }
/*      */   static {
/*  621 */     instance = new CharacterData00();
/*      */ 
/*  629 */     X = "".toCharArray();
/*      */ 
/*  790 */     Y = "".toCharArray();
