...
/*  122 */
        this.maxPriority = paramThreadGroup.maxPriority;
/*  123 */
...
/*      */ {
/*  291 */
        for (; paramThreadGroup != null; paramThreadGroup = paramThreadGroup.parent) {
/*  292 */
...
/*  438 */
                    paramArrayOfThread[(paramInt++)] = this.threads[j];
/*      */
                }
/*      */
            }
...
/*  570 */
            if (i > 0) {
/*  571 */
                System.arraycopy(this.groups, 0, paramArrayOfThreadGroup, paramInt, i);
/*  572 */
                paramInt += i;
/*      */
            }
...
/*  702 */
            if (this.groups != null) {
/*  703 */
                arrayOfThreadGroup = (ThreadGroup[]) Arrays.copyOf(this.groups, localObject1);
/*      */
            }
/*      */
        }
...
/* 1001 */
                paramPrintStream.println(this.threads[i]);
/*      */
            }
/* 1003 */
            localObject1 = this.ngroups;
