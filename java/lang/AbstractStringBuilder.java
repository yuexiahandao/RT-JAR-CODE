...
/*  177 */
            for (; this.count < paramInt; this.count += 1)
/*  178 */
...
/*  232 */
        return Character.codePointAt(this.value, paramInt);
/*      */
    }
...
/*  261 */
        return Character.codePointBefore(this.value, paramInt);
/*      */
    }
...
/*  482 */
            this.value[k] = paramCharSequence.charAt(j);
/*      */ 
/*  481 */
            j++;
/*      */
...
/*      */ {
/*  657 */
        new FloatingDecimal(paramFloat).appendTo(this);
/*  658 */
        return this;
/*      */
    }
...
/*      */ {
/*  674 */
        new FloatingDecimal(paramDouble).appendTo(this);
/*  675 */
        return this;
/*      */
    }
...
/* 1103 */
            this.value[(paramInt1++)] = paramCharSequence.charAt(j);
/* 1104 */
        this.count += i;
/* 1105 */
        return this;
...
/* 1365 */
            if (i == 0) {
/* 1366 */
                i = ((m >= 55296) && (m <= 57343)) || ((n >= 55296) && (n <= 57343)) ? 1 : 0;
/*      */
            }
/*      */ 
/* 1369 */
