...
/*      */ {
/*  430 */
        double d1 = 4503599627370496.0D;
/*  431 */
        double d2 = FpUtils.rawCopySign(1.0D, paramDouble);
/*  432 */
...
/*  666 */
        return localRandom == null ? (StrictMath.randomNumberGenerator = new Random()) : localRandom;
/*      */
    }
...
/*      */ {
/* 1205 */
        return FpUtils.copySign(paramDouble1, paramDouble2);
/*      */
    }
...
/*      */ {
/* 1221 */
        return FpUtils.copySign(paramFloat1, paramFloat2);
/*      */
    }
