...
/*     */ {
/* 172 */
        return getClassName() + "." + this.methodName + (this.fileName != null ? "(" + this.fileName + ")" : (this.fileName != null) && (this.lineNumber >= 0) ? "(" + this.fileName + ":" + this.lineNumber + ")" : isNativeMethod() ? "(Native Method)" : "(Unknown Source)");
/*     */
    }
...
/* 204 */
        return (localStackTraceElement.declaringClass.equals(this.declaringClass)) && (localStackTraceElement.lineNumber == this.lineNumber) && (Objects.equals(this.methodName, localStackTraceElement.methodName)) && (Objects.equals(this.fileName, localStackTraceElement.fileName));
/*     */
    }
...
/* 215 */
        i = 31 * i + Objects.hashCode(this.fileName);
/* 216 */
