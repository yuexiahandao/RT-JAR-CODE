...
/* 132 */       Reference localReference = reallyPoll();
/* 133 */       if (localReference != null) return localReference; do
/*     */       {
/* 135 */         this.lock.wait(paramLong);
/* 136 */         localReference = reallyPoll();
/* 137 */         if (localReference != null) return localReference; 
/*     */       }
/* 138 */       while (paramLong == 0L); return null;
/*     */     }
/*     */   }
/*     */ 
