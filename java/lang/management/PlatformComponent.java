...
/*     */ {
/*  85 */
            CompilationMXBean localCompilationMXBean = ManagementFactoryHelper.getCompilationMXBean();
/*  86 */
            if (localCompilationMXBean == null) {
/*  87 */
                return Collections.emptyList();
/*     */
            }
/*  89 */
            return Collections.singletonList(localCompilationMXBean);
/*     */
        }
/*     */
    }
...
/*     */ {
/* 197 */
            PlatformLoggingMXBean localPlatformLoggingMXBean = ManagementFactoryHelper.getPlatformLoggingMXBean();
/* 198 */
            if (localPlatformLoggingMXBean == null) {
/* 199 */
                return Collections.emptyList();
/*     */
            }
/* 201 */
            return Collections.singletonList(localPlatformLoggingMXBean);
/*     */
        }
/*     */
    }
...
/* 291 */
        for (GarbageCollectorMXBean localGarbageCollectorMXBean : localList) {
/* 292 */
...
/* 333 */
        this.subComponents = paramArrayOfPlatformComponent;
/*     */
    }
...
/*     */ 
/* 385 */
        List localList = this.fetcher.getMXBeans();
/* 386 */
...
/* 411 */
        for (ObjectName localObjectName : getObjectNames(paramMBeanServerConnection)) {
/* 412 */
...
/* 431 */
        for (PlatformComponent localPlatformComponent : this.subComponents) {
/* 432 */
