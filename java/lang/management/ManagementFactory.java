...
/* 467 */
            for (Object localObject2 : PlatformComponent.values()) {
/* 468 */
                List localList = localObject2.getMXBeans(localObject2.getMXBeanInterface());
/*     */ 
/* 470 */
                for (PlatformManagedObject localPlatformManagedObject : localList)
/*     */ {
/* 480 */
...
/* 585 */
                return this.val$interfaceClass.getClassLoader();
/*     */
            }
/*     */
        });
...
/* 598 */
                throw new IllegalArgumentException(paramString + " is not an instance of " + localClass);
/*     */
            }
/*     */ 
/* 604 */
...
/*     */ 
/* 607 */
            return JMX.newMXBeanProxy(paramMBeanServerConnection, localObjectName, paramClass, bool);
/*     */
        }
...
/*     */
                    Object localObject;
/* 811 */
                    if ((this.val$pmo instanceof DynamicMBean))
/* 812 */ localObject = (DynamicMBean) DynamicMBean.class.cast(this.val$pmo);
/* 813 */
                    else if ((this.val$pmo instanceof NotificationEmitter))
/* 814 */ localObject = new StandardEmitterMBean(this.val$pmo, null, true, (NotificationEmitter) this.val$pmo);
/*     */
                    else {
/* 816 */
                        localObject = new StandardMBean(this.val$pmo, null, true);
/*     */
                    }
/*     */ 
/* 819 */
                    paramMBeanServer.registerMBean(localObject, this.val$pmo.getObjectName());
/* 820 */
                    return null;
/*     */
                }
