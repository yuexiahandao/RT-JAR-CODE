...
/*     */ {
/* 196 */
        return new FloatingDecimal(paramDouble).toJavaFormatString();
/*     */
    }
...
/*     */ {
/* 279 */
        if (!FpUtils.isFinite(paramDouble))
/*     */ {
/* 281 */
...
/*     */ 
/* 284 */
        StringBuffer localStringBuffer = new StringBuffer(24);
/*     */ 
/* 286 */
        if (FpUtils.rawCopySign(1.0D, paramDouble) == -1.0D) {
/* 287 */
...
/* 293 */
        if (paramDouble == 0.0D) {
/* 294 */
            localStringBuffer.append("0.0p0");
/*     */
        }
/*     */
        else {
/* 297 */
            int i = paramDouble < 2.225073858507201E-308D ? 1 : 0;
/*     */ 
/* 302 */
            long l = doubleToLongBits(paramDouble) & 0xFFFFFFFF | 0x0;
/*     */ 
/* 308 */
            localStringBuffer.append(i != 0 ? "0." : "1.");
/*     */ 
/* 314 */
            String str = Long.toHexString(l).substring(3, 16);
/* 315 */
            localStringBuffer.append(str.equals("0000000000000") ? "0" : str.replaceFirst("0{1,12}$", ""));
/*     */ 
/* 323 */
            localStringBuffer.append("p" + (i != 0 ? -1022 : FpUtils.getExponent(paramDouble)));
/*     */
        }
/*     */ 
/* 327 */
...
/*     */ {
/* 504 */
        return new Double(FloatingDecimal.readJavaFormatString(paramString).doubleValue());
/*     */
    }
...
/*     */ {
/* 540 */
        return FloatingDecimal.readJavaFormatString(paramString).doubleValue();
/*     */
    }
...
/*     */ {
/* 597 */
        this(valueOf(paramString).doubleValue());
/*     */
    }
...
/*     */ 
/* 811 */
        if (((l & 0x0) == 9218868437227405312L) && ((l & 0xFFFFFFFF) != 0L))
/*     */ {
/* 814 */
