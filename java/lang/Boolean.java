...
/*     */   {
/*  87 */     this.value = paramBoolean;
/*     */   }
/*     */ 
/*     */   public Boolean(String paramString)
/*     */   {
/* 104 */     this(toBoolean(paramString));
/*     */   }
/*     */ 
/*     */   public static boolean parseBoolean(String paramString)
/*     */   {
/* 121 */     return toBoolean(paramString);
/*     */   }
/*     */ 
...
/*     */   {
/* 149 */     return paramBoolean ? TRUE : FALSE;
/*     */   }
/*     */ 
/*     */   public static Boolean valueOf(String paramString)
/*     */   {
/* 162 */     return toBoolean(paramString) ? TRUE : FALSE;
/*     */   }
/*     */ 
/*     */   public static String toString(boolean paramBoolean)
/*     */   {
/* 176 */     return paramBoolean ? "true" : "false";
/*     */   }
/*     */ 
/*     */   public String toString()
/*     */   {
/* 188 */     return this.value ? "true" : "false";
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
/* 199 */     return this.value ? 1231 : 1237;
/*     */   }
/*     */ 
/*     */   public boolean equals(Object paramObject)
/*     */   {
/* 212 */     if ((paramObject instanceof Boolean)) {
/* 213 */       return this.value == ((Boolean)paramObject).booleanValue();
/*     */     }
/* 215 */     return false;
/*     */   }
/*     */ 
...
/*     */     try {
/* 238 */       bool = toBoolean(System.getProperty(paramString));
...
/*     */   {
/* 258 */     return compare(this.value, paramBoolean.value);
/*     */   }
/*     */ 
/*     */   public static int compare(boolean paramBoolean1, boolean paramBoolean2)
/*     */   {
/* 276 */     return paramBoolean1 ? 1 : paramBoolean1 == paramBoolean2 ? 0 : -1;
/*     */   }
/*     */ 
/*     */   private static boolean toBoolean(String paramString) {
/* 280 */     return (paramString != null) && (paramString.equalsIgnoreCase("true"));
/*     */   }
/*     */ }
