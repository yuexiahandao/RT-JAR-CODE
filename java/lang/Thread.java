...
/*  411 */     this.inheritedAccessControlContext = (paramAccessControlContext != null ? paramAccessControlContext : AccessController.getContext());
/*      */ 
/*  413 */     this.target = paramRunnable;
/*  414 */     setPriority(this.priority);
/*  415 */     if (localThread.inheritableThreadLocals != null) {
/*  416 */       this.inheritableThreadLocals = ThreadLocal.createInheritedMap(localThread.inheritableThreadLocals);
/*      */     }
/*      */ 
...
/*      */   {
/*  704 */     if (this.threadStatus != 0) {
/*  705 */       throw new IllegalThreadStateException();
/*      */     }
/*      */ 
/*  710 */     this.group.add(this);
/*      */ 
/*  712 */     int i = 0;
/*      */     try {
/*  714 */       start0();
...
/*      */   {
/*  836 */     stop(new ThreadDeath());
/*      */   }
/*      */ 
/*      */   @Deprecated
/*      */   public final synchronized void stop(Throwable paramThrowable)
/*      */   {
/*  890 */     if (paramThrowable == null) {
/*  891 */       throw new NullPointerException();
/*      */     }
/*  893 */     SecurityManager localSecurityManager = System.getSecurityManager();
/*  894 */     if (localSecurityManager != null) {
/*  895 */       checkAccess();
/*  896 */       if ((this != currentThread()) || (!(paramThrowable instanceof ThreadDeath)))
/*      */       {
/*  898 */         localSecurityManager.checkPermission(SecurityConstants.STOP_THREAD_PERMISSION);
/*      */       }
/*      */ 
/*      */     }
/*      */ 
/*  903 */     if (this.threadStatus != 0) {
/*  904 */       resume();
/*      */     }
/*      */ 
/*  908 */     stop0(paramThrowable);
/*      */   }
/*      */ 
/*      */   public void interrupt()
/*      */   {
/*  951 */     if (this != currentThread()) {
/*  952 */       checkAccess();
/*      */     }
/*  954 */     synchronized (this.blockerLock) {
/*  955 */       Interruptible localInterruptible = this.blocker;
/*  956 */       if (localInterruptible != null) {
/*  957 */         interrupt0();
/*  958 */         localInterruptible.interrupt(this);
/*  959 */         return;
/*      */       }
/*      */     }
/*  962 */     interrupt0();
...
/*      */   {
/* 1123 */     checkAccess();
/* 1124 */     if ((paramInt > 10) || (paramInt < 1))
/* 1125 */       throw new IllegalArgumentException();
/*      */     ThreadGroup localThreadGroup;
/* 1127 */     if ((localThreadGroup = getThreadGroup()) != null) {
/* 1128 */       if (paramInt > localThreadGroup.getMaxPriority()) {
/* 1129 */         paramInt = localThreadGroup.getMaxPriority();
/*      */       }
/* 1131 */       setPriority0(this.priority = paramInt);
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/* 1160 */     checkAccess();
/* 1161 */     this.name = paramString.toCharArray();
/*      */   }
/*      */ 
/*      */   public final String getName()
/*      */   {
/* 1171 */     return String.valueOf(this.name);
/*      */   }
/*      */ 
/*      */   public final ThreadGroup getThreadGroup()
/*      */   {
/* 1182 */     return this.group;
/*      */   }
/*      */ 
...
/*      */   {
/* 1232 */     return currentThread().getThreadGroup().enumerate(paramArrayOfThread);
/*      */   }
/*      */ 
/*      */   @Deprecated
...
/*      */     throws InterruptedException
/*      */   {
/* 1272 */     long l1 = System.currentTimeMillis();
/* 1273 */     long l2 = 0L;
/*      */ 
/* 1275 */     if (paramLong < 0L) {
...
/*      */     }
/* 1284 */     while (isAlive()) {
/* 1285 */       long l3 = paramLong - l2;
/* 1286 */       if (l3 <= 0L) {
/*      */         break;
/*      */       }
/* 1289 */       wait(l3);
/* 1290 */       l2 = System.currentTimeMillis() - l1;
/*      */     }
/*      */   }
/*      */ 
...
/*      */     }
/*      */ 
/* 1327 */     if ((paramInt < 0) || (paramInt > 999999)) {
/* 1328 */       throw new IllegalArgumentException("nanosecond timeout value out of range");
/*      */     }
/*      */ 
/* 1332 */     if ((paramInt >= 500000) || ((paramInt != 0) && (paramLong == 0L))) {
/* 1333 */       paramLong += 1L;
/*      */     }
/*      */ 
/* 1336 */     join(paramLong);
...
/*      */     }
/* 1390 */     this.daemon = paramBoolean;
/*      */   }
/*      */ 
/*      */   public final boolean isDaemon()
/*      */   {
/* 1401 */     return this.daemon;
/*      */   }
/*      */ 
/*      */   public final void checkAccess()
/*      */   {
/* 1417 */     SecurityManager localSecurityManager = System.getSecurityManager();
/* 1418 */     if (localSecurityManager != null)
/* 1419 */       localSecurityManager.checkAccess(this);
/*      */   }
/*      */ 
/*      */   public String toString()
/*      */   {
/* 1430 */     ThreadGroup localThreadGroup = getThreadGroup();
/* 1431 */     if (localThreadGroup != null) {
/* 1432 */       return "Thread[" + getName() + "," + getPriority() + "," + localThreadGroup.getName() + "]";
/*      */     }
/*      */ 
...
/*      */   {
/* 1468 */     if (this.contextClassLoader == null) {
/* 1469 */       return null;
/*      */     }
/* 1471 */     SecurityManager localSecurityManager = System.getSecurityManager();
/* 1472 */     if (localSecurityManager != null) {
/* 1473 */       ClassLoader.checkClassLoaderPermission(this.contextClassLoader, Reflection.getCallerClass());
/*      */     }
/*      */ 
/* 1476 */     return this.contextClassLoader;
/*      */   }
/*      */ 
/*      */   public void setContextClassLoader(ClassLoader paramClassLoader)
/*      */   {
/* 1502 */     SecurityManager localSecurityManager = System.getSecurityManager();
/* 1503 */     if (localSecurityManager != null) {
/* 1504 */       localSecurityManager.checkPermission(new RuntimePermission("setContextClassLoader"));
/*      */     }
/* 1506 */     this.contextClassLoader = paramClassLoader;
/*      */   }
/*      */ 
...
/*      */   {
/* 1567 */     if (this != currentThread())
/*      */     {
/* 1569 */       SecurityManager localSecurityManager = System.getSecurityManager();
/* 1570 */       if (localSecurityManager != null) {
/* 1571 */         localSecurityManager.checkPermission(SecurityConstants.GET_STACK_TRACE_PERMISSION);
/*      */       }
/*      */ 
/* 1576 */       if (!isAlive()) {
/* 1577 */         return EMPTY_STACK_TRACE;
/*      */       }
/* 1579 */       StackTraceElement[][] arrayOfStackTraceElement = dumpThreads(new Thread[] { this });
/* 1580 */       StackTraceElement[] arrayOfStackTraceElement1 = arrayOfStackTraceElement[0];
/*      */ 
/* 1583 */       if (arrayOfStackTraceElement1 == null) {
/* 1584 */         arrayOfStackTraceElement1 = EMPTY_STACK_TRACE;
/*      */       }
/* 1586 */       return arrayOfStackTraceElement1;
/*      */     }
/*      */ 
/* 1589 */     return new Exception().getStackTrace();
/*      */   }
/*      */ 
/*      */   public static Map<Thread, StackTraceElement[]> getAllStackTraces()
/*      */   {
/* 1630 */     SecurityManager localSecurityManager = System.getSecurityManager();
/* 1631 */     if (localSecurityManager != null) {
/* 1632 */       localSecurityManager.checkPermission(SecurityConstants.GET_STACK_TRACE_PERMISSION);
/*      */ 
/* 1634 */       localSecurityManager.checkPermission(SecurityConstants.MODIFY_THREADGROUP_PERMISSION);
/*      */     }
/*      */ 
/* 1639 */     Thread[] arrayOfThread = getThreads();
/* 1640 */     StackTraceElement[][] arrayOfStackTraceElement = dumpThreads(arrayOfThread);
/* 1641 */     HashMap localHashMap = new HashMap(arrayOfThread.length);
/* 1642 */     for (int i = 0; i < arrayOfThread.length; i++) {
/* 1643 */       StackTraceElement[] arrayOfStackTraceElement1 = arrayOfStackTraceElement[i];
/* 1644 */       if (arrayOfStackTraceElement1 != null) {
/* 1645 */         localHashMap.put(arrayOfThread[i], arrayOfStackTraceElement1);
/*      */       }
/*      */     }
/*      */ 
/* 1649 */     return localHashMap;
/*      */   }
/*      */ 
/*      */   private static boolean isCCLOverridden(Class paramClass)
/*      */   {
/* 1676 */     if (paramClass == Thread.class) {
/* 1677 */       return false;
/*      */     }
/* 1679 */     processQueue(Caches.subclassAuditsQueue, Caches.subclassAudits);
/* 1680 */     WeakClassKey localWeakClassKey = new WeakClassKey(paramClass, Caches.subclassAuditsQueue);
/* 1681 */     Boolean localBoolean = (Boolean)Caches.subclassAudits.get(localWeakClassKey);
/* 1682 */     if (localBoolean == null) {
/* 1683 */       localBoolean = Boolean.valueOf(auditSubclass(paramClass));
/* 1684 */       Caches.subclassAudits.putIfAbsent(localWeakClassKey, localBoolean);
/*      */     }
/*      */ 
/* 1687 */     return localBoolean.booleanValue();
/*      */   }
/*      */ 
/*      */   private static boolean auditSubclass(Class paramClass)
/*      */   {
/* 1696 */     Boolean localBoolean = (Boolean)AccessController.doPrivileged(new PrivilegedAction()
/*      */     {
/*      */       public Boolean run() {
/* 1699 */         for (Class localClass = this.val$subcl; 
/* 1700 */           localClass != Thread.class; 
/* 1701 */           localClass = localClass.getSuperclass())
/*      */           try
/*      */           {
/* 1704 */             localClass.getDeclaredMethod("getContextClassLoader", new Class[0]);
/* 1705 */             return Boolean.TRUE;
/*      */           }
/*      */           catch (NoSuchMethodException localNoSuchMethodException1) {
/*      */             try {
/* 1709 */               Class[] arrayOfClass = { ClassLoader.class };
/* 1710 */               localClass.getDeclaredMethod("setContextClassLoader", arrayOfClass);
...
/*      */       }
/*      */     });
/* 1719 */     return localBoolean.booleanValue();
/*      */   }
/*      */ 
...
/*      */   public long getId()
/*      */   {
/* 1735 */     return this.tid;
/*      */   }
/*      */ 
/*      */   public State getState()
/*      */   {
/* 1847 */     return VM.toThreadState(this.threadStatus);
/*      */   }
/*      */ 
/*      */   public static void setDefaultUncaughtExceptionHandler(UncaughtExceptionHandler paramUncaughtExceptionHandler)
/*      */   {
/* 1927 */     SecurityManager localSecurityManager = System.getSecurityManager();
/* 1928 */     if (localSecurityManager != null) {
/* 1929 */       localSecurityManager.checkPermission(new RuntimePermission("setDefaultUncaughtExceptionHandler"));
/*      */     }
/*      */ 
/* 1934 */     defaultUncaughtExceptionHandler = paramUncaughtExceptionHandler;
/*      */   }
/*      */ 
/*      */   public static UncaughtExceptionHandler getDefaultUncaughtExceptionHandler()
/*      */   {
/* 1945 */     return defaultUncaughtExceptionHandler;
/*      */   }
/*      */ 
/*      */   public UncaughtExceptionHandler getUncaughtExceptionHandler()
/*      */   {
/* 1957 */     return this.uncaughtExceptionHandler != null ? this.uncaughtExceptionHandler : this.group;
/*      */   }
/*      */ 
/*      */   public void setUncaughtExceptionHandler(UncaughtExceptionHandler paramUncaughtExceptionHandler)
/*      */   {
/* 1977 */     checkAccess();
/* 1978 */     this.uncaughtExceptionHandler = paramUncaughtExceptionHandler;
/*      */   }
/*      */ 
/*      */   private void dispatchUncaughtException(Throwable paramThrowable)
/*      */   {
/* 1986 */     getUncaughtExceptionHandler().uncaughtException(this, paramThrowable);
/*      */   }
/*      */ 
...
/* 1998 */     while ((localReference = paramReferenceQueue.poll()) != null)
...
/*      */     {
/* 2018 */       super(paramReferenceQueue);
/* 2019 */       this.hash = System.identityHashCode(paramClass);
/*      */     }
/*      */ 
/*      */     public int hashCode()
/*      */     {
/* 2027 */       return this.hash;
/*      */     }
/*      */ 
/*      */     public boolean equals(Object paramObject)
/*      */     {
/* 2038 */       if (paramObject == this) {
/* 2039 */         return true;
/*      */       }
/* 2041 */       if ((paramObject instanceof WeakClassKey)) {
/* 2042 */         Object localObject = get();
/* 2043 */         return (localObject != null) && (localObject == ((WeakClassKey)paramObject).get());
/*      */       }
/*      */ 
/* 2046 */       return false;
/*      */     }
