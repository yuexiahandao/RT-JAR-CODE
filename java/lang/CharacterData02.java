...
/*     */   {
/*  70 */     int i = (char)paramInt;
/*  71 */     int j = A[(Y[(X[(i >> 5)] | i >> 1 & 0xF)] | i & 0x1)];
/*  72 */     return j;
/*     */   }
/*     */ 
/*     */   int getPropertiesEx(int paramInt) {
/*  76 */     int i = (char)paramInt;
/*  77 */     int j = B[(Y[(X[(i >> 5)] | i >> 1 & 0xF)] | i & 0x1)];
/*  78 */     return j;
/*     */   }
/*     */ 
...
/* 207 */       break;
/*     */     case 1024:
/* 209 */       j = paramInt + ((i & 0x3E0) >> 5) & 0x1F;
/* 210 */       break;
/*     */     case 2048:
/* 212 */       j = -2;
/* 213 */       break;
/*     */     case 3072:
/* 215 */       j = (paramInt + ((i & 0x3E0) >> 5) & 0x1F) + 10;
/*     */     }
/*     */ 
/* 218 */     return j;
/*     */   }
...
/* 235 */     return (getProperties(paramInt) & 0x80000000) != 0;
/*     */   }
/*     */   static {
/* 238 */     instance = new CharacterData02();
/*     */ 
/* 245 */     X = "".toCharArray();
/*     */ 
/* 357 */     Y = "".toCharArray();
...
/* 374 */     B = "".toCharArray();
/*     */ 
/* 381 */     char[] arrayOfChar = "".toCharArray();
/* 382 */     assert (arrayOfChar.length == 16);
/* 383 */     int i = 0; int j = 0;
/* 384 */     while (i < 16) {
/* 385 */       int k = arrayOfChar[(i++)] << '\020';
/* 386 */       A[(j++)] = (k | arrayOfChar[(i++)]);
/*     */     }
/*     */   }
/*     */ }

/* Location:           C:\Program Files\Java\jdk1.7.0_79\jre\lib\rt.jar
 * Qualified Name:     java.lang.CharacterData02
