...
/*  362 */
                this.cachedConstructor = localConstructor2;
/*      */
...
/*  367 */
        Constructor localConstructor1 = this.cachedConstructor;
/*      */ 
/*  369 */
...
/*  371 */
            Class localClass = Reflection.getCallerClass();
/*  372 */
            if (this.newInstanceCallerCache != localClass) {
/*  373 */
                Reflection.ensureMemberAccess(localClass, this, null, i);
/*  374 */
                this.newInstanceCallerCache = localClass;
/*      */
            }
/*      */
        }
...
/*      */ {
/*  379 */
            return localConstructor1.newInstance((Object[]) null);
/*      */
...
/* 1196 */
        int j = 1;
/* 1197 */
        while ((j < i) && (isAsciiDigit(str.charAt(j)))) {
/* 1198 */
            j++;
/*      */
        }
...
/* 1667 */
        checkMemberAccess(0, Reflection.getCallerClass(), true);
/* 1668 */
        Method localMethod = getMethod0(paramString, paramArrayOfClass);
/* 1669 */
        if (localMethod == null) {
/* 1670 */
            throw new NoSuchMethodException(getName() + "." + paramString + argumentTypesToString(paramArrayOfClass));
/*      */
        }
/* 1672 */
        return localMethod;
...
/* 1722 */
        checkMemberAccess(0, Reflection.getCallerClass(), true);
/* 1723 */
        return getConstructor0(paramArrayOfClass, 0);
/*      */
    }
...
/* 2006 */
        checkMemberAccess(1, Reflection.getCallerClass(), true);
/* 2007 */
        Method localMethod = searchMethods(privateGetDeclaredMethods(false), paramString, paramArrayOfClass);
/* 2008 */
        if (localMethod == null) {
/* 2009 */
            throw new NoSuchMethodException(getName() + "." + paramString + argumentTypesToString(paramArrayOfClass));
...
/* 2057 */
        checkMemberAccess(1, Reflection.getCallerClass(), true);
/* 2058 */
        return getConstructor0(paramArrayOfClass, 1);
/*      */
    }
...
/*      */ {
/* 2237 */
        if (paramSecurityManager.getClass() == SecurityManager.class) return false;
/*      */ 
/* 2239 */
        SecurityManagerHelper localSecurityManagerHelper = smHelper;
/* 2240 */
        if ((localSecurityManagerHelper == null) || (localSecurityManagerHelper.sm != paramSecurityManager)) {
/* 2241 */
            localSecurityManagerHelper = new SecurityManagerHelper(paramSecurityManager);
/* 2242 */
            smHelper = localSecurityManagerHelper;
/*      */
        }
/* 2244 */
        return localSecurityManagerHelper.overrideCheckMemberAccess;
/*      */
    }
...
/* 2277 */
            if (!isCheckMemberAccessOverridden(localSecurityManager))
/*      */ {
/* 2279 */
                if ((paramInt != 0) &&
...
/*      */ {
/* 2287 */
                localSecurityManager.checkMemberAccess(this, paramInt);
/*      */
            }
/* 2289 */
...
/*      */ {
/* 2418 */
        SoftReference localSoftReference = this.reflectionData;
/* 2419 */
        int i = this.classRedefinedCount;
/*      */
        ReflectionData localReflectionData;
/* 2421 */
        if ((useCaches) && (localSoftReference != null) && ((localReflectionData = (ReflectionData) localSoftReference.get()) != null) && (localReflectionData.redefinedCount == i))
/*      */ {
/* 2425 */
...
/* 2445 */
            if ((paramSoftReference != null) && ((localReflectionData = (ReflectionData) paramSoftReference.get()) != null) && (localReflectionData.redefinedCount == paramInt))
/*      */ {
/* 2448 */
                return localReflectionData;
/*      */
...
/* 2495 */
            arrayOfField = paramBoolean ? localReflectionData.declaredPublicFields : localReflectionData.declaredFields;
/* 2496 */
            if (arrayOfField != null) return arrayOfField;
/*      */
        }
/*      */ 
/* 2499 */
...
/* 2504 */
                localReflectionData.declaredFields = arrayOfField;
/*      */
            }
/*      */
        }
...
/* 2517 */
        if (localReflectionData != null) {
/* 2518 */
            arrayOfField1 = localReflectionData.publicFields;
/* 2519 */
            if (arrayOfField1 != null) return arrayOfField1;
/*      */ 
/*      */
        }
/*      */ 
...
/* 2537 */
                addAll(localArrayList, localObject2.privateGetPublicFields(paramSet));
/*      */
            }
/*      */ 
/*      */
...
/* 2551 */
        if (localReflectionData != null) {
/* 2552 */
            localReflectionData.publicFields = arrayOfField1;
/*      */
        }
/* 2554 */
...
/* 2577 */
        if (localReflectionData != null) {
/* 2578 */
            arrayOfConstructor = paramBoolean ? localReflectionData.publicConstructors : localReflectionData.declaredConstructors;
/* 2579 */
            if (arrayOfConstructor != null) return arrayOfConstructor;
/*      */
        }
/*      */ 
/* 2582 */
...
/* 2591 */
                localReflectionData.declaredConstructors = arrayOfConstructor;
/*      */
            }
/*      */
        }
...
/* 2610 */
        if (localReflectionData != null) {
/* 2611 */
            arrayOfMethod = paramBoolean ? localReflectionData.declaredPublicMethods : localReflectionData.declaredMethods;
/* 2612 */
            if (arrayOfMethod != null) return arrayOfMethod;
/*      */
        }
/*      */ 
/* 2615 */
...
/* 2620 */
                localReflectionData.declaredMethods = arrayOfMethod;
/*      */
            }
/*      */
        }
...
/* 2724 */
        if (localReflectionData != null) {
/* 2725 */
            arrayOfMethod = localReflectionData.publicMethods;
/* 2726 */
            if (arrayOfMethod != null) return arrayOfMethod;
/*      */ 
/*      */
...
/* 2742 */
        for (int i = 0; i < arrayOfClass.length; i++)
/* 2743 */
            ((MethodArray) localObject1).addAll(arrayOfClass[i].privateGetPublicMethods());
/*      */
        Object localObject2;
/* 2745 */
        if (!isInterface()) {
/* 2746 */
            Class localClass = getSuperclass();
/* 2747 */
            if (localClass != null) {
/* 2748 */
                localObject2 = new MethodArray();
/* 2749 */
                ((MethodArray) localObject2).addAll(localClass.privateGetPublicMethods());
/*      */ 
/* 2752 */
                for (int k = 0; k < ((MethodArray) localObject2).length(); k++) {
/* 2753 */
                    Method localMethod = ((MethodArray) localObject2).get(k);
/* 2754 */
                    if ((localMethod != null) && (!Modifier.isAbstract(localMethod.getModifiers()))) {
/* 2755 */
                        ((MethodArray) localObject1).removeByNameAndSignature(localMethod);
/*      */
                    }
/*      */ 
/*      */
...
/*      */ 
/* 2761 */
                ((MethodArray) localObject2).addAll((MethodArray) localObject1);
/* 2762 */
...
/*      */ 
/* 2766 */
        for (int j = 0; j < localMethodArray.length(); j++) {
/* 2767 */
            localObject2 = localMethodArray.get(j);
/* 2768 */
            ((MethodArray) localObject1).removeByNameAndSignature((Method) localObject2);
/*      */
        }
/* 2770 */
...
/* 2773 */
        if (localReflectionData != null) {
/* 2774 */
            localReflectionData.publicMethods = arrayOfMethod;
/*      */
        }
/* 2776 */
        return arrayOfMethod;
...
/* 2835 */
            if ((localMethod.getName() == str) && (arrayContentsEq(paramArrayOfClass, localMethod.getParameterTypes())) && ((localObject == null) || (localObject.getReturnType().isAssignableFrom(localMethod.getReturnType()))))
/*      */ {
/* 2839 */
...
/* 2842 */
        return localObject == null ? localObject : getReflectionFactory().copyMethod(localObject);
/*      */
    }
...
/*      */
        Method localMethod;
/* 2856 */
        if ((localMethod = searchMethods(privateGetDeclaredMethods(true), paramString, paramArrayOfClass)) != null)
/*      */ {
/* 2859 */
            return localMethod;
/*      */
...
/* 2874 */
            if ((localMethod = localObject2.getMethod0(paramString, paramArrayOfClass)) != null) {
/* 2875 */
                return localMethod;
/*      */
            }
...
/*      */ 
/* 3025 */
        synchronized (localClassLoader.assertionLock) {
/* 3026 */
            if (localClassLoader.classAssertionStatus != null) {
/* 3027 */
...
/* 3086 */
                    Class.access$502(false);
/*      */
                }
/*      */ 
/* 3089 */
                Class.access$602(true);
/* 3090 */
                return null;
/*      */
            }
...
/* 3128 */
                this.enumConstants = ((Object[]) localMethod.invoke(null, new Object[0]));
/*      */
            }
/*      */ catch (InvocationTargetException localInvocationTargetException)
/*      */ {
...
/* 3156 */
            this.enumConstantDirectory = localHashMap;
/*      */
        }
/* 3158 */
...
/* 3220 */
        return (Annotation) this.annotations.get(paramClass);
/*      */
    }
...
/*      */ {
/* 3261 */
        if (this.lastAnnotationsRedefinedCount != this.classRedefinedCount) {
/* 3262 */
            this.annotations = (this.declaredAnnotations = null);
/* 3263 */
            this.lastAnnotationsRedefinedCount = this.classRedefinedCount;
/*      */
        }
/*      */
    }
...
/* 3278 */
            localClass1.initAnnotationsIfNecessary();
/* 3279 */
            for (Map.Entry localEntry : localClass1.annotations.entrySet()) {
/* 3280 */
...
/*      */ {
/*  984 */
                this.enclosingClass = ((Class) paramArrayOfObject[0]);
/*  985 */
                assert (this.enclosingClass != null);
/*      */ 
/*  989 */
                this.name = ((String) paramArrayOfObject[1]);
/*      */ 
/*  993 */
                this.descriptor = ((String) paramArrayOfObject[2]);
/*  994 */
                if ((!$assertionsDisabled) && ((this.name == null) || (this.descriptor == null)) && (this.name != this.descriptor))
                    throw new AssertionError();
/*      */
            }
/*  996 */ catch (ClassCastException localClassCastException) {
...
/* 2639 */
            this.methods[(this.length++)] = paramMethod;
/*      */
        }
...
/* 2683 */
                Method localMethod = this.methods[i];
/* 2684 */
                if ((localMethod != null) && (localMethod.getReturnType() == paramMethod.getReturnType()) && (localMethod.getName() == paramMethod.getName()) && (Class.arrayContentsEq(localMethod.getParameterTypes(), paramMethod.getParameterTypes())))
/*      */ {
/* 2689 */
                    this.methods[i] = null;
/*      */
...
/* 2698 */
                Method localMethod = this.methods[j];
/* 2699 */
                if (localMethod != null) {
/* 2700 */
                    if (j != i) {
/* 2701 */
                        this.methods[i] = localMethod;
/*      */
                    }
/* 2703 */
                    i++;
...
/* 2221 */
            boolean bool = false;
/* 2222 */
            if (paramSecurityManager.getClass() != SecurityManager.class) {
/*      */
                try {
/* 2224 */
                    bool = Class.getCheckMemberAccessMethod(paramSecurityManager.getClass()).getDeclaringClass() != SecurityManager.class;
/*      */
                }
...
/* 2230 */
            this.overrideCheckMemberAccess = bool;
/*      */
        }
/*      */
    }
