...
/*      */   {
/* 1134 */     checkPermission(new SocketPermission("localhost:" + paramInt, "listen"));
/*      */   }
/*      */ 
...
/*      */     }
/* 1167 */     if ((!paramString.startsWith("[")) && (paramString.indexOf(':') != -1)) {
/* 1168 */       paramString = "[" + paramString + "]";
/*      */     }
/* 1170 */     checkPermission(new SocketPermission(paramString + ":" + paramInt, "accept"));
/*      */   }
/*      */ 
/*      */   public void checkMulticast(InetAddress paramInetAddress)
/*      */   {
/* 1197 */     String str = paramInetAddress.getHostAddress();
/* 1198 */     if ((!str.startsWith("[")) && (str.indexOf(':') != -1)) {
/* 1199 */       str = "[" + str + "]";
/*      */     }
/* 1201 */     checkPermission(new SocketPermission(str, "connect,accept"));
/*      */   }
/*      */ 
/*      */   @Deprecated
/*      */   public void checkMulticast(InetAddress paramInetAddress, byte paramByte)
/*      */   {
/* 1233 */     String str = paramInetAddress.getHostAddress();
/* 1234 */     if ((!str.startsWith("[")) && (str.indexOf(':') != -1)) {
/* 1235 */       str = "[" + str + "]";
/*      */     }
/* 1237 */     checkPermission(new SocketPermission(str, "connect,accept"));
/*      */   }
/*      */ 
/*      */   public void checkPropertiesAccess()
/*      */   {
/* 1265 */     checkPermission(new PropertyPermission("*", "read,write"));
/*      */   }
/*      */ 
/*      */   public void checkPropertyAccess(String paramString)
/*      */   {
/* 1298 */     checkPermission(new PropertyPermission(paramString, "read"));
/*      */   }
/*      */ 
/*      */   public boolean checkTopLevelWindow(Object paramObject)
/*      */   {
/* 1336 */     if (paramObject == null)
/* 1337 */       throw new NullPointerException("window can't be null");
/*      */     try
/*      */     {
/* 1340 */       checkPermission(SecurityConstants.AWT.TOPLEVEL_WINDOW_PERMISSION);
/* 1341 */       return true;
/*      */     }
...
/*      */   {
/* 1390 */     checkPermission(SecurityConstants.AWT.ACCESS_CLIPBOARD_PERMISSION);
/*      */   }
/*      */ 
/*      */   public void checkAwtEventQueueAccess()
/*      */   {
/* 1411 */     checkPermission(SecurityConstants.AWT.CHECK_AWT_EVENTQUEUE_PERMISSION);
/*      */   }
/*      */ 
/*      */   private static String[] getPackages(String paramString)
/*      */   {
/* 1439 */     String[] arrayOfString = null;
/* 1440 */     if ((paramString != null) && (!paramString.equals(""))) {
/* 1441 */       StringTokenizer localStringTokenizer = new StringTokenizer(paramString, ",");
/*      */ 
/* 1443 */       int i = localStringTokenizer.countTokens();
/* 1444 */       if (i > 0) {
/* 1445 */         arrayOfString = new String[i];
/* 1446 */         int j = 0;
/* 1447 */         while (localStringTokenizer.hasMoreElements()) {
/* 1448 */           String str = localStringTokenizer.nextToken().trim();
/* 1449 */           arrayOfString[(j++)] = str;
/*      */         }
/*      */       }
/*      */     }
/*      */ 
/* 1454 */     if (arrayOfString == null)
/* 1455 */       arrayOfString = new String[0];
/* 1456 */     return arrayOfString;
/*      */   }
/*      */ 
/*      */   public void checkPackageAccess(String paramString)
/*      */   {
/* 1492 */     if (paramString == null)
...
/* 1502 */         String str = (String)AccessController.doPrivileged(new PrivilegedAction()
/*      */         {
/*      */           public String run()
/*      */           {
/* 1506 */             return Security.getProperty("package.access");
/*      */           }
/*      */         });
/* 1511 */         packageAccess = getPackages(str);
/* 1512 */         packageAccessValid = true;
/*      */       }
/*      */ 
/* 1517 */       arrayOfString = packageAccess;
/*      */     }
/*      */ 
/* 1523 */     for (int i = 0; i < arrayOfString.length; i++)
/* 1524 */       if ((paramString.startsWith(arrayOfString[i])) || (arrayOfString[i].equals(paramString + "."))) {
/* 1525 */         checkPermission(new RuntimePermission("accessClassInPackage." + paramString));
/*      */ 
/* 1527 */         break;
/*      */       }
/*      */   }
...
/*      */   {
/* 1561 */     if (paramString == null)
/* 1562 */       throw new NullPointerException("package name can't be null");
/*      */     String[] arrayOfString;
/* 1566 */     synchronized (packageDefinitionLock)
/*      */     {
/* 1570 */       if (!packageDefinitionValid) {
/* 1571 */         String str = (String)AccessController.doPrivileged(new PrivilegedAction()
/*      */         {
/*      */           public String run()
/*      */           {
/* 1575 */             return Security.getProperty("package.definition");
/*      */           }
/*      */         });
/* 1580 */         packageDefinition = getPackages(str);
/* 1581 */         packageDefinitionValid = true;
/*      */       }
/*      */ 
/* 1585 */       arrayOfString = packageDefinition;
/*      */     }
/*      */ 
/* 1591 */     for (int i = 0; i < arrayOfString.length; i++)
/* 1592 */       if ((paramString.startsWith(arrayOfString[i])) || (arrayOfString[i].equals(paramString + "."))) {
/* 1593 */         checkPermission(new RuntimePermission("defineClassInPackage." + paramString));
/*      */ 
/* 1595 */         break;
/*      */       }
/*      */   }
...
/*      */   {
/* 1625 */     checkPermission(new RuntimePermission("setFactory"));
/*      */   }
/*      */ 
/*      */   public void checkMemberAccess(Class<?> paramClass, int paramInt)
/*      */   {
/* 1657 */     if (paramClass == null) {
/* 1658 */       throw new NullPointerException("class can't be null");
/*      */     }
/* 1660 */     if (paramInt != 0) {
/* 1661 */       Class[] arrayOfClass = getClassContext();
/*      */ 
/* 1673 */       if ((arrayOfClass.length < 4) || (arrayOfClass[3].getClassLoader() != paramClass.getClassLoader()))
/*      */       {
/* 1675 */         checkPermission(SecurityConstants.CHECK_MEMBER_ACCESS_PERMISSION);
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/* 1711 */     checkPermission(new SecurityPermission(paramString));
/*      */   }
/*      */ 
...
/*      */   {
/* 1728 */     return Thread.currentThread().getThreadGroup();
/*      */   }
/*      */ }
