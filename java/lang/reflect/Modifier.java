...
/*     */ 
/* 239 */
        if ((paramInt & 0x1) != 0) localStringBuffer.append("public ");
/* 240 */
        if ((paramInt & 0x4) != 0) localStringBuffer.append("protected ");
/* 241 */
        if ((paramInt & 0x2) != 0) localStringBuffer.append("private ");
/*     */ 
/* 244 */
        if ((paramInt & 0x400) != 0) localStringBuffer.append("abstract ");
/* 245 */
        if ((paramInt & 0x8) != 0) localStringBuffer.append("static ");
/* 246 */
        if ((paramInt & 0x10) != 0) localStringBuffer.append("final ");
/* 247 */
        if ((paramInt & 0x80) != 0) localStringBuffer.append("transient ");
/* 248 */
        if ((paramInt & 0x40) != 0) localStringBuffer.append("volatile ");
/* 249 */
        if ((paramInt & 0x20) != 0) localStringBuffer.append("synchronized ");
/* 250 */
        if ((paramInt & 0x100) != 0) localStringBuffer.append("native ");
/* 251 */
        if ((paramInt & 0x800) != 0) localStringBuffer.append("strictfp ");
/* 252 */
        if ((paramInt & 0x200) != 0) localStringBuffer.append("interface ");
/*     */
        int i;
/* 254 */
