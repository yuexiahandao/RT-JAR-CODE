...
/* 310 */
        if ((localSecurityManager != null) && (ProxyAccessHelper.needsNewInstanceCheck(localClass)))
/*     */ try {
/* 312 */
            localSecurityManager.checkPermission(ProxyAccessHelper.PROXY_PERMISSION);
/*     */
        } catch (SecurityException localSecurityException) {
/* 314 */
            throw new SecurityException("Not allowed to construct a Proxy instance that implements a non-public interface", localSecurityException);
/*     */
        }
/*     */
    }
...
/* 433 */
            if ((paramClassLoader == null) && (localClassLoader != null) &&
...
/*     */ 
/* 438 */
            ReflectUtil.checkProxyPackageAccess(localClassLoader, paramArrayOfClass);
/*     */
        }
/*     */
    }
...
/*     */ {
/* 448 */
        if (paramArrayOfClass.length > 65535) {
/* 449 */
...
/*     */ 
/* 455 */
        return (Class) proxyClassCache.get(paramClassLoader, paramArrayOfClass);
/*     */
    }
...
/* 745 */
            final InvocationHandler localInvocationHandler = paramInvocationHandler;
/* 746 */
            if ((localSecurityManager != null) && (ProxyAccessHelper.needsNewInstanceCheck(localClass)))
/*     */ {
/* 749 */
                return AccessController.doPrivileged(new PrivilegedAction() {
                    ...
                    public Object run() {
/* 751 */
                        return Proxy.newInstance(this.val$cons, localInvocationHandler);
/*     */
                    }
/*     */
                });
...
/* 755 */
            return newInstance(localConstructor, localInvocationHandler);
/*     */
        }
/*     */ catch (NoSuchMethodException localNoSuchMethodException) {
/* 758 */
            throw new InternalError(localNoSuchMethodException.toString());
/*     */
        }
/*     */
    }
...
/*     */
        try {
/* 764 */
            return paramConstructor.newInstance(new Object[]{paramInvocationHandler});
/*     */
        } catch (IllegalAccessException | InstantiationException localIllegalAccessException) {
/* 766 */
            throw new InternalError(localIllegalAccessException.toString());
/*     */
...
/* 772 */
            throw new InternalError(localThrowable.toString());
/*     */
        }
/*     */
    }
...
/* 815 */
        InvocationHandler localInvocationHandler = localProxy.h;
/* 816 */
...
/* 503 */
            super();
/* 504 */
            this.hash = (31 * paramClass1.hashCode() + paramClass2.hashCode());
/* 505 */
            this.ref2 = new WeakReference(paramClass2);
/*     */
        }
...
/*     */
            Class localClass2;
/* 516 */
            return (this == paramObject) || ((paramObject != null) && (paramObject.getClass() == Key2.class) && ((localClass1 = (Class) get()) != null) && (localClass1 == ((Key2) paramObject).get()) && ((localClass2 = (Class) this.ref2.get()) != null) && (localClass2 == ((Key2) paramObject).ref2.get()));
/*     */
        }
/*     */
    }
...
/*     */ {
/* 535 */
            this.hash = Arrays.hashCode(paramArrayOfClass);
/* 536 */
            this.refs = new WeakReference[paramArrayOfClass.length];
/* 537 */
            for (int i = 0; i < paramArrayOfClass.length; i++)
/* 538 */
                this.refs[i] = new WeakReference(paramArrayOfClass[i]);
/*     */
        }
...
/*     */ {
/* 549 */
            return (this == paramObject) || ((paramObject != null) && (paramObject.getClass() == KeyX.class) && (equals(this.refs, ((KeyX) paramObject).refs)));
/*     */
        }
...
/* 286 */
            if ((!Proxy.isProxyClass(paramClass)) || (allowNewInstance)) {
/* 287 */
                return false;
/*     */
            }
...
/*     */
                try {
/* 612 */
                    localObject3 = Class.forName(localObject2.getName(), false, paramClassLoader);
/*     */
...
/* 624 */
                    throw new IllegalArgumentException(((Class) localObject3).getName() + " is not an interface");
/*     */
                }
/*     */ 
/* 630 */
                if (localIdentityHashMap.put(localObject3, Boolean.TRUE) != null) {
/* 631 */
                    throw new IllegalArgumentException("repeated interface: " + ((Class) localObject3).getName());
/*     */
                }
/*     */ 
/*     */
...
/* 643 */
            for (localObject3:
                 paramArrayOfClass) {
/* 644 */
                int m = ((Class) localObject3).getModifiers();
/* 645 */
...
/* 648 */
                    String str3 = n == -1 ? "" : str2.substring(0, n + 1);
/* 649 */
                    if (???==null)
/* 650 */
                    ???=str3;
