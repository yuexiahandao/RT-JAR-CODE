...
/*  287 */
        int i = getModifiers();
/*  288 */
        return (i == 0 ? "" : new StringBuilder().append(Modifier.toString(i)).append(" ").toString()) + getTypeName(getType()) + " " + getTypeName(getDeclaringClass()) + "." + getName();
/*      */
    }
...
/*  316 */
        return (i == 0 ? "" : new StringBuilder().append(Modifier.toString(i)).append(" ").toString()) + ((localType instanceof Class) ? getTypeName((Class) localType) : localType.toString()) + " " + getTypeName(getDeclaringClass()) + "." + getName();
/*      */
    }
...
/*  376 */
            checkAccess(Reflection.getCallerClass(), this.clazz, paramObject, this.modifiers);
/*      */
        }
/*      */ 
/*  379 */
...
/*  738 */
            checkAccess(Reflection.getCallerClass(), this.clazz, paramObject1, this.modifiers);
/*      */
        }
/*      */ 
/*  741 */
...
/* 1049 */
        if (this.root != null) localFieldAccessor = this.root.getFieldAccessor(paramBoolean);
/* 1050 */
...
/* 1096 */
            localStringBuffer.append(((Class) localObject).getName());
/* 1097 */
            for (int j = 0; j < i; j++) {
/* 1098 */
