...
/* 178 */     if ((localEnum.getClass() != ?.getClass()) && (localEnum.getDeclaringClass() != ?.getDeclaringClass()))
/*     */     {
...
/*     */   {
/* 197 */     Class localClass1 = getClass();
/* 198 */     Class localClass2 = localClass1.getSuperclass();
/* 199 */     return localClass2 == Enum.class ? localClass1 : localClass2;
/*     */   }
/*     */ 
/*     */   public static <T extends Enum<T>> T valueOf(Class<T> paramClass, String paramString)
/*     */   {
/* 231 */     Enum localEnum = (Enum)paramClass.enumConstantDirectory().get(paramString);
/* 232 */     if (localEnum != null)
/* 233 */       return localEnum;
/* 234 */     if (paramString == null)
/* 235 */       throw new NullPointerException("Name is null");
/* 236 */     throw new IllegalArgumentException("No enum constant " + paramClass.getCanonicalName() + "." + paramString);
/*     */   }
/*     */ 
