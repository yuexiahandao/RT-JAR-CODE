...
/*     */ 
/* 115 */
        return getFromBackup(arrayOfEntry, paramClass);
/*     */
    }
...
/*     */ {
/* 189 */
        ClassValueMap localClassValueMap = paramClass.classValueMap;
/* 190 */
        if (localClassValueMap == null) return EMPTY_CACHE;
/* 191 */
...
/* 367 */
        ClassValueMap localClassValueMap = paramClass.classValueMap;
/* 368 */
        if (localClassValueMap != null) return localClassValueMap;
/* 369 */
...
/*     */ {
/* 377 */
            if ((localClassValueMap = paramClass.classValueMap) == null)
...
/*     */ {
/* 430 */
            ClassValue.Entry localEntry = (ClassValue.Entry) get(paramClassValue.identity);
/* 431 */
...
/*     */ 
/* 436 */
                put(paramClassValue.identity, localEntry);
/*     */ 
/* 438 */
                return localEntry;
/* 439 */
...
/* 470 */
                remove(paramClassValue.identity);
/* 471 */
                return null;
/* 472 */
            }
...
/* 478 */
                put(paramClassValue.identity, paramEntry);
/*     */ 
/* 480 */
                checkCacheLoad();
/* 481 */
...
/*     */ {
/* 492 */
            ClassValue.Entry localEntry = (ClassValue.Entry) remove(paramClassValue.identity);
/* 493 */
            if (localEntry != null)
/*     */ {
/* 495 */
...
/*     */ {
/* 512 */
            ClassValue.Entry localEntry1 = (ClassValue.Entry) get(paramClassValue.identity);
/* 513 */
            ClassValue.Version localVersion = paramClassValue.version();
/* 514 */
            if (localEntry1 != null) {
...
/* 522 */
            put(paramClassValue.identity, localEntry2);
/*     */ 
/* 524 */
            checkCacheLoad();
/* 525 */
...
/*     */ {
/* 544 */
            return paramClassValue.castEntry(loadFromCache(paramArrayOfEntry, paramClassValue.hashCodeForCache));
/*     */
        }
...
/* 552 */
            int j = paramClassValue.hashCodeForCache & i;
/* 553 */
...
/* 586 */
            if (localClassValue == null) return 0;
/* 587 */
            int i = paramArrayOfEntry.length - 1;
/* 588 */
            return paramInt - localClassValue.hashCodeForCache & i;
/*     */
        }
...
/* 597 */
            this.cacheLoad = 0;
/* 598 */
            this.cacheLoadLimit = ((int) (paramInt * 67.0D / 100.0D));
/* 599 */
            this.cacheArray = new ClassValue.Entry[paramInt];
/*     */
        }
...
/*     */ {
/* 690 */
            removeStaleEntries(getCache(), paramClassValue.hashCodeForCache, 6);
/*     */
        }
...
/*     */ {
/* 749 */
            if (paramEntry == null) this.cacheLoad += 1;
/* 750 */
            else if (paramEntry.isLive()) return paramEntry;
/* 751 */
            return null;
/*     */
        }
...
/* 337 */
        ...
        /* 338 */     boolean isPromise() {
            return this.value == this;
        }

        /* 339 */     ClassValue.Version<T> version() {
...
/* 347 */
            if (localVersion.isLive()) return true;
/* 348 */
            clear();
/* 349 */
            return false;
...
/*     */ 
/* 354 */
            Entry localEntry = new Entry(paramVersion, this.value);
/* 355 */
            clear();
/*     */ 
/* 357 */
...
/*     */ {
        ...
        /*     */
/* 306 */     Version(ClassValue<T> paramClassValue) {
            this.classValue = paramClassValue;
        }

        /* 307 */     ClassValue<T> classValue() {
            return this.classValue;
        }

        /* 308 */     ClassValue.Entry<T> promise() {
            return this.promise;
        }
