...
/*     */ {
/* 105 */
        this.target = paramMethodType.invokers().uninitializedCallSite();
/*     */
    }
...
/* 134 */
        checkTargetChange(this.target, localMethodHandle);
/* 135 */
        this.target = localMethodHandle;
/*     */
    }
...
/*     */ {
/* 214 */
        MethodHandle localMethodHandle1 = GET_TARGET.bindReceiver(this);
/* 215 */
        MethodHandle localMethodHandle2 = MethodHandles.exactInvoker(type());
/* 216 */
        return MethodHandles.foldArguments(localMethodHandle2, localMethodHandle1);
/*     */
    }
...
/* 276 */
                if (3 + localObject2.length > 255)
/* 277 */ throw new BootstrapMethodError("too many bootstrap method arguments");
/* 278 */
                MethodType localMethodType = paramMethodHandle.type();
/* 279 */
                if ((localMethodType.parameterCount() == 4) && (localMethodType.parameterType(3) ==[Ljava.lang.Object.class))
/* 280 */
                localObject1 = paramMethodHandle.invoke(localLookup, paramString, paramMethodType, (Object[]) localObject2);
/*     */
                else{
/* 282 */
                    localObject1 = MethodHandles.spreadInvoker(localMethodType, 3).invoke(paramMethodHandle, localLookup, paramString, paramMethodType, (Object[]) localObject2);
/*     */
                }
/*     */
            }
