...
/*     */ {
/* 137 */
        if ((paramInt == 0) && (paramChar == 'L')) {
/* 138 */
            DirectMethodHandle localDirectMethodHandle = maybeRebind(paramObject);
/* 139 */
            if (localDirectMethodHandle != null)
/* 140 */ return localDirectMethodHandle.bindReceiver(paramObject);
/*     */
        }
/* 142 */
        return super.bindArgument(paramInt, paramChar, paramObject);
/*     */
    }
...
/* 151 */
        return super.bindReceiver(paramObject);
/*     */
    }
...
/* 163 */
                    MemberName localMemberName = new MemberName(localClass, this.member.getName(), this.member.getMethodType(), (byte) 7);
/* 164 */
                    localMemberName = IMPL_NAMES.resolveOrNull((byte) 7, localMemberName, localClass);
/* 165 */
...
/* 181 */
        assert ((!paramMemberName.isMethodHandleInvoke()) || ("invokeBasic".equals(paramMemberName.getName()))) : paramMemberName;
/*     */
        int i;
/* 183 */
...
/* 253 */
        Object[] arrayOfObject = Arrays.copyOfRange(arrayOfName, 1, i1 + 1,[Ljava.lang.Object.class);
/* 254 */
...
/* 263 */
        String str2 = str2 + "_" + LambdaForm.basicTypeSignature(paramMethodType);
/* 264 */
...
/* 279 */
        return ((DirectMethodHandle) paramObject).member;
/*     */
    }
...
/* 288 */
        return localDirectMethodHandle.member;
/*     */
    }
...
/* 360 */
        else MethodHandleStatics.UNSAFE.ensureClassInitialized(localClass);
/*     */ 
/* 362 */
...
/* 388 */
        return localConstructor.initMethod;
/*     */
    }
...
/* 392 */
        Constructor localConstructor = (Constructor) paramObject;
/* 393 */
        return MethodHandleStatics.UNSAFE.allocateInstance(localConstructor.instanceClass);
/*     */
    }
...
/*     */ {
/* 416 */
        return ((Accessor) paramObject).fieldOffset;
/*     */
    }
...
/* 459 */
        return ((StaticAccessor) paramObject).staticBase;
/*     */
    }
...
/* 464 */
        return ((StaticAccessor) paramObject).staticOffset;
/*     */
    }
...
/* 473 */
        return this.member.getReturnType().cast(paramObject);
/*     */
    }
...
/* 554 */
        if (!$assertionsDisabled)
            if (ftypeKind(m != 0 ? String.class : localClass) != paramInt) throw new AssertionError();
/* 555 */
        String str1 = localWrapper.primitiveSimpleName();
/* 556 */
        String str2 = Character.toUpperCase(str1.charAt(0)) + str1.substring(1);
/* 557 */
        if (paramBoolean) str2 = str2 + "Volatile";
/* 558 */
...
/* 603 */
        if (!$assertionsDisabled) if (arrayOfObject.length != (i != 0 ? 3 : 4)) throw new AssertionError();
/* 604 */
...
/*     */ {
/*     */
            void tmp686_683 = new LambdaForm.Name(Lazy.NF_staticBase, new Object[]{arrayOfName[0]});
            arrayOfName[i4] = tmp686_683;
            arrayOfObject[1] = tmp686_683;
/*     */
            void tmp717_714 = new LambdaForm.Name(Lazy.NF_staticOffset, new Object[]{arrayOfName[0]});
            arrayOfName[i5] = tmp717_714;
            arrayOfObject[2] = tmp717_714;
/*     */
        }
/*     */
        else
/*     */ {
/*     */
            void tmp752_749 = new LambdaForm.Name(Lazy.NF_checkBase, new Object[]{arrayOfName[i1]});
            arrayOfName[i6] = tmp752_749;
            arrayOfObject[1] = tmp752_749;
/*     */
            void tmp783_780 = new LambdaForm.Name(Lazy.NF_fieldOffset, new Object[]{arrayOfName[0]});
            arrayOfName[i5] = tmp783_780;
            arrayOfObject[2] = tmp783_780;
/*     */
        }
/* 612 */
        if (i == 0)
...
/* 622 */
        if (m != 0) str5 = str5 + "Cast";
/* 623 */
        if (k != 0) str5 = str5 + "Init";
/* 624 */
...
/* 403 */
            this.fieldType = paramMemberName.getFieldType();
/* 404 */
            this.fieldOffset = paramInt;
/*     */
        }
...
/*     */     Object checkCast(Object paramObject) {
/* 408 */
            return this.fieldType.cast(paramObject);
/*     */
        }
/*     */
    }
...
/* 380 */
            this.initMethod = paramMemberName2;
/* 381 */
...
/*     */
                void tmp49_46 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("internalMemberName", new Class[]{Object.class}));
                NF_internalMemberName = tmp49_46;
                tmp22_19[0] = tmp49_46;
/*     */
                LambdaForm.NamedFunction[] tmp54_22 = tmp22_19;
/*     */
                void tmp81_78 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("internalMemberNameEnsureInit", new Class[]{Object.class}));
                NF_internalMemberNameEnsureInit = tmp81_78;
                tmp54_22[1] = tmp81_78;
/*     */
                LambdaForm.NamedFunction[] tmp86_54 = tmp54_22;
/*     */
                void tmp113_110 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("ensureInitialized", new Class[]{Object.class}));
                NF_ensureInitialized = tmp113_110;
                tmp86_54[2] = tmp113_110;
/*     */
                LambdaForm.NamedFunction[] tmp118_86 = tmp86_54;
/*     */
                void tmp145_142 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("fieldOffset", new Class[]{Object.class}));
                NF_fieldOffset = tmp145_142;
                tmp118_86[3] = tmp145_142;
/*     */
                LambdaForm.NamedFunction[] tmp150_118 = tmp118_86;
/*     */
                void tmp177_174 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("checkBase", new Class[]{Object.class}));
                NF_checkBase = tmp177_174;
                tmp150_118[4] = tmp177_174;
/*     */
                LambdaForm.NamedFunction[] tmp182_150 = tmp150_118;
/*     */
                void tmp209_206 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("staticBase", new Class[]{Object.class}));
                NF_staticBase = tmp209_206;
                tmp182_150[5] = tmp209_206;
/*     */
                LambdaForm.NamedFunction[] tmp214_182 = tmp182_150;
/*     */
                void tmp242_239 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("staticOffset", new Class[]{Object.class}));
                NF_staticOffset = tmp242_239;
                tmp214_182[6] = tmp242_239;
/*     */
                LambdaForm.NamedFunction[] tmp247_214 = tmp214_182;
/*     */
                void tmp281_278 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("checkCast", new Class[]{Object.class, Object.class}));
                NF_checkCast = tmp281_278;
                tmp247_214[7] = tmp281_278;
/*     */
                LambdaForm.NamedFunction[] tmp286_247 = tmp247_214;
/*     */
                void tmp314_311 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("allocateInstance", new Class[]{Object.class}));
                NF_allocateInstance = tmp314_311;
                tmp286_247[8] = tmp314_311;
/*     */
                LambdaForm.NamedFunction[] tmp319_286 = tmp286_247;
/*     */
                void tmp347_344 = new LambdaForm.NamedFunction(DirectMethodHandle.class.getDeclaredMethod("constructorMethod", new Class[]{Object.class}));
                NF_constructorMethod = tmp347_344;
                tmp319_286[9] = tmp347_344;
                LambdaForm.NamedFunction[] arrayOfNamedFunction1 = tmp319_286;
/*     */ 
/* 667 */
...
/* 441 */
            this.fieldType = paramMemberName.getFieldType();
/* 442 */
            this.staticBase = paramObject;
/* 443 */
            this.staticOffset = paramLong;
/*     */
        }
