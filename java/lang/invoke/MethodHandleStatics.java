...
/*  89 */
        if (paramMethodHandle == null) return str;
/*  90 */
        int i = str.indexOf('(');
/*  91 */
...
/*     */ {
/*  97 */
        InternalError localInternalError = new InternalError(paramString);
/*  98 */
        localInternalError.initCause(paramThrowable);
/*  99 */
...
/* 128 */
        if (paramObject != null) paramString = paramString + ": " + paramObject;
/* 129 */
        return paramString;
/*     */
    }
...
/*     */ {
/*  50 */
        Object[] arrayOfObject = {Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), null};
/*  51 */
        AccessController.doPrivileged(new PrivilegedAction() {
            /*     */
            public Void run() {
/*  53 */
                this.val$values[0] = Boolean.valueOf(Boolean.getBoolean("java.lang.invoke.MethodHandle.DEBUG_NAMES"));
/*  54 */
                this.val$values[1] = Boolean.valueOf(Boolean.getBoolean("java.lang.invoke.MethodHandle.DUMP_CLASS_FILES"));
/*  55 */
                this.val$values[2] = Boolean.valueOf(Boolean.getBoolean("java.lang.invoke.MethodHandle.TRACE_INTERPRETER"));
/*  56 */
                this.val$values[3] = Boolean.valueOf(Boolean.getBoolean("java.lang.invoke.MethodHandle.TRACE_METHOD_LINKAGE"));
/*  57 */
                this.val$values[4] = Integer.getInteger("java.lang.invoke.MethodHandle.COMPILE_THRESHOLD");
/*  58 */
                return null;
/*     */
            }
