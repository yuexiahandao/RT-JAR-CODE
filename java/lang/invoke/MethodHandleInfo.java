...
/* 50 */
        this.declaringClass = localMemberName.getDeclaringClass();
/* 51 */
        this.name = localMemberName.getName();
/* 52 */
        this.methodType = localMemberName.getMethodType();
/* 53 */
        this.referenceKind = localMemberName.getReferenceKind();
/*    */
    }
