...
/* 173 */
        return MethodHandles.guardWithTest(this.mcsInvoker, paramMethodHandle1, paramMethodHandle2);
/*     */
    }
...
/*     */ {
/* 218 */
        if (paramArrayOfSwitchPoint.length == 0) return;
/* 219 */
...
/* 222 */
            if (localSwitchPoint == null) break;
/* 223 */
            arrayOfMutableCallSite[i] = localSwitchPoint.mcs;
/* 224 */
            localSwitchPoint.mcs.setTarget(K_false);
/*     */
        }
/* 226 */
