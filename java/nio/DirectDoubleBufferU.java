...
/*     */ 
/*     */ class DirectDoubleBufferU extends DoubleBuffer
...
/* 217 */     return new DirectDoubleBufferU(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public DoubleBuffer asReadOnlyBuffer()
/*     */   {
/* 227 */     return new DirectDoubleBufferRU(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public long address()
/*     */   {
...
/*     */   {
/* 291 */     unsafe.putDouble(ix(nextPutIndex()), paramDouble);
/* 292 */     return this;
/*     */   }
/*     */ 
/*     */   public DoubleBuffer put(int paramInt, double paramDouble)
/*     */   {
/* 300 */     unsafe.putDouble(ix(checkIndex(paramInt)), paramDouble);
/* 301 */     return this;
/*     */   }
/*     */ 
...
/*     */     int j;
/*     */     int k;
/* 309 */     if ((paramDoubleBuffer instanceof DirectDoubleBufferU)) {
/* 310 */       if (paramDoubleBuffer == this)
/* 311 */         throw new IllegalArgumentException();
/* 312 */       DirectDoubleBufferU localDirectDoubleBufferU = (DirectDoubleBufferU)paramDoubleBuffer;
/*     */ 
/* 314 */       j = localDirectDoubleBufferU.position();
/* 315 */       k = localDirectDoubleBufferU.limit();
/* 316 */       assert (j <= k);
/* 317 */       int m = j <= k ? k - j : 0;
/*     */ 
/* 319 */       int n = position();
...
/* 326 */       unsafe.copyMemory(localDirectDoubleBufferU.ix(j), ix(n), m << 3);
/* 327 */       localDirectDoubleBufferU.position(j + m);
/* 328 */       position(n + m);
 ...
 * Qualified Name:     java.nio.DirectDoubleBufferU
