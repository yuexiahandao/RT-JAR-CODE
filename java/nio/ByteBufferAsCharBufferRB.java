...
/*  83 */     return new ByteBufferAsCharBufferRB(this.bb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */ 
...
/* 199 */     return new ByteBufferAsCharBufferRB(this.bb, -1, i + paramInt1, i + paramInt2, capacity(), this.offset);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     java.nio.ByteBufferAsCharBufferRB
