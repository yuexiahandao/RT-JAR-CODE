...
/*     */ 
/*     */ class DirectFloatBufferS extends FloatBuffer
...
/* 217 */     return new DirectFloatBufferS(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public FloatBuffer asReadOnlyBuffer()
/*     */   {
/* 227 */     return new DirectFloatBufferRS(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public long address()
/*     */   {
...
/*     */   {
/* 291 */     unsafe.putInt(ix(nextPutIndex()), Bits.swap(Float.floatToRawIntBits(paramFloat)));
/* 292 */     return this;
/*     */   }
/*     */ 
/*     */   public FloatBuffer put(int paramInt, float paramFloat)
/*     */   {
/* 300 */     unsafe.putInt(ix(checkIndex(paramInt)), Bits.swap(Float.floatToRawIntBits(paramFloat)));
/* 301 */     return this;
/*     */   }
/*     */ 
...
/*     */     int j;
/*     */     int k;
/* 309 */     if ((paramFloatBuffer instanceof DirectFloatBufferS)) {
/* 310 */       if (paramFloatBuffer == this)
/* 311 */         throw new IllegalArgumentException();
/* 312 */       DirectFloatBufferS localDirectFloatBufferS = (DirectFloatBufferS)paramFloatBuffer;
/*     */ 
/* 314 */       j = localDirectFloatBufferS.position();
/* 315 */       k = localDirectFloatBufferS.limit();
/* 316 */       assert (j <= k);
/* 317 */       int m = j <= k ? k - j : 0;
/*     */ 
/* 319 */       int n = position();
...
/* 326 */       unsafe.copyMemory(localDirectFloatBufferS.ix(j), ix(n), m << 2);
/* 327 */       localDirectFloatBufferS.position(j + m);
/* 328 */       position(n + m);
 ...
 * Qualified Name:     java.nio.DirectFloatBufferS
