...
/*     */ 
/*     */ class DirectCharBufferS extends CharBuffer
...
/* 217 */     return new DirectCharBufferS(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public CharBuffer asReadOnlyBuffer()
/*     */   {
/* 227 */     return new DirectCharBufferRS(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public long address()
/*     */   {
...
/*     */   {
/* 291 */     unsafe.putChar(ix(nextPutIndex()), Bits.swap(paramChar));
/* 292 */     return this;
/*     */   }
/*     */ 
/*     */   public CharBuffer put(int paramInt, char paramChar)
/*     */   {
/* 300 */     unsafe.putChar(ix(checkIndex(paramInt)), Bits.swap(paramChar));
/* 301 */     return this;
/*     */   }
/*     */ 
...
/*     */     int j;
/*     */     int k;
/* 309 */     if ((paramCharBuffer instanceof DirectCharBufferS)) {
/* 310 */       if (paramCharBuffer == this)
/* 311 */         throw new IllegalArgumentException();
/* 312 */       DirectCharBufferS localDirectCharBufferS = (DirectCharBufferS)paramCharBuffer;
/*     */ 
/* 314 */       j = localDirectCharBufferS.position();
/* 315 */       k = localDirectCharBufferS.limit();
/* 316 */       assert (j <= k);
/* 317 */       int m = j <= k ? k - j : 0;
/*     */ 
/* 319 */       int n = position();
...
/* 326 */       unsafe.copyMemory(localDirectCharBufferS.ix(j), ix(n), m << 1);
/* 327 */       localDirectCharBufferS.position(j + m);
/* 328 */       position(n + m);
...
/* 434 */     return new DirectCharBufferS(this, -1, i + paramInt1, i + paramInt2, capacity(), this.offset);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     java.nio.DirectCharBufferS
