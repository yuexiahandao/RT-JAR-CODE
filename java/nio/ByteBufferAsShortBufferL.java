...
/*  83 */     return new ByteBufferAsShortBufferL(this.bb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */ 
/*     */   public ShortBuffer asReadOnlyBuffer()
/*     */   {
/*  93 */     return new ByteBufferAsShortBufferRL(this.bb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */ 
...
/*     */   {
/* 122 */     Bits.putShortL(this.bb, ix(nextPutIndex()), paramShort);
/* 123 */     return this;
/*     */   }
/*     */ 
/*     */   public ShortBuffer put(int paramInt, short paramShort)
/*     */   {
/* 131 */     Bits.putShortL(this.bb, ix(checkIndex(paramInt)), paramShort);
/* 132 */     return this;
/*     */   }
/*     */ 
 ...
 * Qualified Name:     java.nio.ByteBufferAsShortBufferL
