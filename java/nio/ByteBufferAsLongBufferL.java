...
/*  83 */     return new ByteBufferAsLongBufferL(this.bb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */ 
/*     */   public LongBuffer asReadOnlyBuffer()
/*     */   {
/*  93 */     return new ByteBufferAsLongBufferRL(this.bb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */ 
...
/*     */   {
/* 122 */     Bits.putLongL(this.bb, ix(nextPutIndex()), paramLong);
/* 123 */     return this;
/*     */   }
/*     */ 
/*     */   public LongBuffer put(int paramInt, long paramLong)
/*     */   {
/* 131 */     Bits.putLongL(this.bb, ix(checkIndex(paramInt)), paramLong);
/* 132 */     return this;
/*     */   }
/*     */ 
 ...
 * Qualified Name:     java.nio.ByteBufferAsLongBufferL
