...
/*  78 */     assert (m >= 0);
/*  79 */     return new ByteBufferAsCharBufferB(this.bb, -1, 0, k, k, m);
/*     */   }
/*     */ 
/*     */   public CharBuffer duplicate() {
/*  83 */     return new ByteBufferAsCharBufferB(this.bb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */ 
/*     */   public CharBuffer asReadOnlyBuffer()
/*     */   {
/*  93 */     return new ByteBufferAsCharBufferRB(this.bb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */ 
...
/*     */   {
/* 122 */     Bits.putCharB(this.bb, ix(nextPutIndex()), paramChar);
/* 123 */     return this;
/*     */   }
/*     */ 
/*     */   public CharBuffer put(int paramInt, char paramChar)
/*     */   {
/* 131 */     Bits.putCharB(this.bb, ix(checkIndex(paramInt)), paramChar);
/* 132 */     return this;
/*     */   }
/*     */ 
...
/* 199 */     return new ByteBufferAsCharBufferB(this.bb, -1, i + paramInt1, i + paramInt2, capacity(), this.offset);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     java.nio.ByteBufferAsCharBufferB
