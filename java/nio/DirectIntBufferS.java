...
/*     */ 
/*     */ class DirectIntBufferS extends IntBuffer
...
/* 217 */     return new DirectIntBufferS(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public IntBuffer asReadOnlyBuffer()
/*     */   {
/* 227 */     return new DirectIntBufferRS(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public long address()
/*     */   {
...
/*     */   {
/* 291 */     unsafe.putInt(ix(nextPutIndex()), Bits.swap(paramInt));
/* 292 */     return this;
/*     */   }
/*     */ 
/*     */   public IntBuffer put(int paramInt1, int paramInt2)
/*     */   {
/* 300 */     unsafe.putInt(ix(checkIndex(paramInt1)), Bits.swap(paramInt2));
/* 301 */     return this;
/*     */   }
/*     */ 
...
/*     */     int j;
/*     */     int k;
/* 309 */     if ((paramIntBuffer instanceof DirectIntBufferS)) {
/* 310 */       if (paramIntBuffer == this)
/* 311 */         throw new IllegalArgumentException();
/* 312 */       DirectIntBufferS localDirectIntBufferS = (DirectIntBufferS)paramIntBuffer;
/*     */ 
/* 314 */       j = localDirectIntBufferS.position();
/* 315 */       k = localDirectIntBufferS.limit();
/* 316 */       assert (j <= k);
/* 317 */       int m = j <= k ? k - j : 0;
/*     */ 
/* 319 */       int n = position();
...
/* 326 */       unsafe.copyMemory(localDirectIntBufferS.ix(j), ix(n), m << 2);
/* 327 */       localDirectIntBufferS.position(j + m);
/* 328 */       position(n + m);
 ...
 * Qualified Name:     java.nio.DirectIntBufferS
