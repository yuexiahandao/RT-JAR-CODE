...
/*     */ 
/*     */ class DirectLongBufferU extends LongBuffer
...
/* 217 */     return new DirectLongBufferU(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public LongBuffer asReadOnlyBuffer()
/*     */   {
/* 227 */     return new DirectLongBufferRU(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */ 
/*     */   public long address()
/*     */   {
...
/*     */   {
/* 291 */     unsafe.putLong(ix(nextPutIndex()), paramLong);
/* 292 */     return this;
/*     */   }
/*     */ 
/*     */   public LongBuffer put(int paramInt, long paramLong)
/*     */   {
/* 300 */     unsafe.putLong(ix(checkIndex(paramInt)), paramLong);
/* 301 */     return this;
/*     */   }
/*     */ 
...
/*     */     int j;
/*     */     int k;
/* 309 */     if ((paramLongBuffer instanceof DirectLongBufferU)) {
/* 310 */       if (paramLongBuffer == this)
/* 311 */         throw new IllegalArgumentException();
/* 312 */       DirectLongBufferU localDirectLongBufferU = (DirectLongBufferU)paramLongBuffer;
/*     */ 
/* 314 */       j = localDirectLongBufferU.position();
/* 315 */       k = localDirectLongBufferU.limit();
/* 316 */       assert (j <= k);
/* 317 */       int m = j <= k ? k - j : 0;
/*     */ 
/* 319 */       int n = position();
...
/* 326 */       unsafe.copyMemory(localDirectLongBufferU.ix(j), ix(n), m << 3);
/* 327 */       localDirectLongBufferU.position(j + m);
/* 328 */       position(n + m);
 ...
 * Qualified Name:     java.nio.DirectLongBufferU
