...
/*  83 */     return new ByteBufferAsDoubleBufferL(this.bb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */ 
/*     */   public DoubleBuffer asReadOnlyBuffer()
/*     */   {
/*  93 */     return new ByteBufferAsDoubleBufferRL(this.bb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */ 
...
/*     */   {
/* 122 */     Bits.putDoubleL(this.bb, ix(nextPutIndex()), paramDouble);
/* 123 */     return this;
/*     */   }
/*     */ 
/*     */   public DoubleBuffer put(int paramInt, double paramDouble)
/*     */   {
/* 131 */     Bits.putDoubleL(this.bb, ix(checkIndex(paramInt)), paramDouble);
/* 132 */     return this;
/*     */   }
/*     */ 
 ...
 * Qualified Name:     java.nio.ByteBufferAsDoubleBufferL
