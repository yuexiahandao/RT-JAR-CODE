...
/*     */ 
/*     */   static String bytecodeName(int paramInt)
/*     */   {
/* 181 */     if (!validBytecode(paramInt)) {
/* 182 */       throw new IllegalArgumentException(String.valueOf(paramInt));
/*     */     }
/*     */ 
/* 186 */     return String.valueOf(paramInt);
/*     */   }
/*     */ 
/*     */   static boolean validIcode(int paramInt)
/*     */   {
/* 266 */     return (-64 <= paramInt) && (paramInt <= -1);
/*     */   }
/*     */ 
/*     */   static boolean validTokenCode(int paramInt)
/*     */   {
/* 271 */     return (2 <= paramInt) && (paramInt <= 80);
/*     */   }
/*     */ 
/*     */   static boolean validBytecode(int paramInt)
/*     */   {
/* 277 */     return (validIcode(paramInt)) || (validTokenCode(paramInt));
/*     */   }
/*     */ }

/* Location:           C:\Program Files\Java\jdk1.7.0_79\jre\lib\rt.jar
 * Qualified Name:     sun.org.mozilla.javascript.internal.Icode
