...
/*  46 */     return unsafe.getByteVolatile(this.base, this.fieldOffset);
/*     */   }
/*     */ 
...
/*  83 */       unsafe.putByteVolatile(this.base, this.fieldOffset, ((Byte)paramObject2).byteValue());
/*  84 */       return;
/*     */     }
...
/*  99 */       throwFinalFieldIllegalAccessException(paramByte);
/*     */     }
/* 101 */     unsafe.putByteVolatile(this.base, this.fieldOffset, paramByte);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     sun.reflect.UnsafeQualifiedStaticByteFieldAccessorImpl
