...
/*  83 */       unsafe.putShort(paramObject1, this.fieldOffset, (short)((Byte)paramObject2).byteValue());
/*  84 */       return;
/*     */     }
/*  86 */     if ((paramObject2 instanceof Short)) {
/*  87 */       unsafe.putShort(paramObject1, this.fieldOffset, ((Short)paramObject2).shortValue());
/*  88 */       return;
/*     */     }
...
/*     */     throws IllegalArgumentException, IllegalAccessException
/*     */   {
/* 114 */     ensureObj(paramObject);
/* 115 */     if (this.isFinal) {
/* 116 */       throwFinalFieldIllegalAccessException(paramShort);
/*     */     }
/* 118 */     unsafe.putShort(paramObject, this.fieldOffset, paramShort);
/*     */   }
/*     */ 
/*     */   public void setInt(Object paramObject, int paramInt)
/*     */     throws IllegalArgumentException, IllegalAccessException
/*     */   {
/* 124 */     throwSetIllegalArgumentException(paramInt);
/*     */   }
/*     */ 
/*     */   public void setLong(Object paramObject, long paramLong)
/*     */     throws IllegalArgumentException, IllegalAccessException
/*     */   {
/* 130 */     throwSetIllegalArgumentException(paramLong);
/*     */   }
/*     */ 
/*     */   public void setFloat(Object paramObject, float paramFloat)
/*     */     throws IllegalArgumentException, IllegalAccessException
/*     */   {
/* 136 */     throwSetIllegalArgumentException(paramFloat);
/*     */   }
/*     */ 
/*     */   public void setDouble(Object paramObject, double paramDouble)
/*     */     throws IllegalArgumentException, IllegalAccessException
/*     */   {
/* 142 */     throwSetIllegalArgumentException(paramDouble);
/*     */   }
/*     */ }

/* Location:           C:\Program Files\Java\jdk1.7.0_79\jre\lib\rt.jar
 * Qualified Name:     sun.reflect.UnsafeShortFieldAccessorImpl
