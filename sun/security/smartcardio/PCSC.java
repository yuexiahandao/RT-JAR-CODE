...
/* 174 */   private static final char[] hexDigits = "0123456789abcdef".toCharArray();
/*     */ 
/*     */   static void checkAvailable()
/*     */     throws RuntimeException
/*     */   {
/*  47 */     if (initException != null)
/*  48 */       throw new UnsupportedOperationException("PC/SC not available on this platform", initException);
/*     */   }
/*     */ 
...
/*     */   {
/* 177 */     StringBuffer localStringBuffer = new StringBuffer(paramArrayOfByte.length * 3);
/* 178 */     for (int i = 0; i < paramArrayOfByte.length; i++) {
/* 179 */       int j = paramArrayOfByte[i] & 0xFF;
/* 180 */       if (i != 0) {
/* 181 */         localStringBuffer.append(':');
/*     */       }
/* 183 */       localStringBuffer.append(hexDigits[(j >>> 4)]);
/* 184 */       localStringBuffer.append(hexDigits[(j & 0xF)]);
/*     */     }
 ...
 * Qualified Name:     sun.security.smartcardio.PCSC
