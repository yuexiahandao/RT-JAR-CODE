...
/*     */ 
/*     */ public class JvmMemGCTableMeta extends SnmpMibTable
...
/*     */   {
/*  97 */     return new JvmMemGCEntryMeta(paramSnmpMib, this.objectserver);
/*     */   }
/*     */ 
...
/*     */   {
/* 133 */     this.node = createJvmMemGCEntryMetaNode("JvmMemGCEntry", "JvmMemGCTable", paramSnmpMib, paramMBeanServer);
/*     */   }
/*     */ 
/*     */   public synchronized void addEntry(SnmpOid paramSnmpOid, ObjectName paramObjectName, Object paramObject)
/*     */     throws SnmpStatusException
/*     */   {
/* 147 */     if (!(paramObject instanceof JvmMemGCEntryMBean)) {
/* 148 */       throw new ClassCastException("Entries for Table \"JvmMemGCTable\" must implement the \"JvmMemGCEntryMBean\" interface.");
/*     */     }
/*     */ 
...
/*     */     throws SnmpStatusException
/*     */   {
/* 164 */     JvmMemGCEntryMBean localJvmMemGCEntryMBean = (JvmMemGCEntryMBean)getEntry(paramSnmpOid);
/* 165 */     synchronized (this) {
/* 166 */       this.node.setInstance(localJvmMemGCEntryMBean);
...
/*     */ 
/* 182 */     JvmMemGCEntryMBean localJvmMemGCEntryMBean = (JvmMemGCEntryMBean)getEntry(paramSnmpOid);
/* 183 */     synchronized (this) {
/* 184 */       this.node.setInstance(localJvmMemGCEntryMBean);
...
/*     */ 
/* 200 */     JvmMemGCEntryMBean localJvmMemGCEntryMBean = (JvmMemGCEntryMBean)getEntry(paramSnmpOid);
/* 201 */     synchronized (this) {
/* 202 */       this.node.setInstance(localJvmMemGCEntryMBean);
...
/*     */     try
/*     */     {
/* 243 */       JvmMemGCEntryMBean localJvmMemGCEntryMBean = (JvmMemGCEntryMBean)getEntry(paramSnmpOid);
/* 244 */       synchronized (this) {
/* 245 */         this.node.setInstance(localJvmMemGCEntryMBean);
 ...
 * Qualified Name:     sun.management.snmp.jvmmib.JvmMemGCTableMeta
