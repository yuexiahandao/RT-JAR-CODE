...
/*     */ 
/*     */ public class JvmMemManagerTableMeta extends SnmpMibTable
...
/*     */   {
/*  97 */     return new JvmMemManagerEntryMeta(paramSnmpMib, this.objectserver);
/*     */   }
/*     */ 
...
/*     */   {
/* 133 */     this.node = createJvmMemManagerEntryMetaNode("JvmMemManagerEntry", "JvmMemManagerTable", paramSnmpMib, paramMBeanServer);
/*     */   }
/*     */ 
/*     */   public synchronized void addEntry(SnmpOid paramSnmpOid, ObjectName paramObjectName, Object paramObject)
/*     */     throws SnmpStatusException
/*     */   {
/* 147 */     if (!(paramObject instanceof JvmMemManagerEntryMBean)) {
/* 148 */       throw new ClassCastException("Entries for Table \"JvmMemManagerTable\" must implement the \"JvmMemManagerEntryMBean\" interface.");
/*     */     }
/*     */ 
...
/*     */     throws SnmpStatusException
/*     */   {
/* 164 */     JvmMemManagerEntryMBean localJvmMemManagerEntryMBean = (JvmMemManagerEntryMBean)getEntry(paramSnmpOid);
/* 165 */     synchronized (this) {
/* 166 */       this.node.setInstance(localJvmMemManagerEntryMBean);
...
/*     */ 
/* 182 */     JvmMemManagerEntryMBean localJvmMemManagerEntryMBean = (JvmMemManagerEntryMBean)getEntry(paramSnmpOid);
/* 183 */     synchronized (this) {
/* 184 */       this.node.setInstance(localJvmMemManagerEntryMBean);
...
/*     */ 
/* 200 */     JvmMemManagerEntryMBean localJvmMemManagerEntryMBean = (JvmMemManagerEntryMBean)getEntry(paramSnmpOid);
/* 201 */     synchronized (this) {
/* 202 */       this.node.setInstance(localJvmMemManagerEntryMBean);
...
/*     */     try
/*     */     {
/* 243 */       JvmMemManagerEntryMBean localJvmMemManagerEntryMBean = (JvmMemManagerEntryMBean)getEntry(paramSnmpOid);
/* 244 */       synchronized (this) {
/* 245 */         this.node.setInstance(localJvmMemManagerEntryMBean);
 ...
 * Qualified Name:     sun.management.snmp.jvmmib.JvmMemManagerTableMeta
