...
/*     */   {
/* 118 */     this.error = paramString;
/* 119 */     this.params = null;
/*     */   }
/*     */ 
/*     */   public AgentConfigurationError(String paramString, Throwable paramThrowable) {
/* 123 */     super(paramThrowable);
/* 124 */     this.error = paramString;
/* 125 */     this.params = null;
/*     */   }
/*     */ 
/*     */   public AgentConfigurationError(String paramString, String[] paramArrayOfString)
/*     */   {
/* 130 */     this.error = paramString;
/* 131 */     this.params = new String[paramArrayOfString.length];
/* 132 */     for (int i = 0; i < paramArrayOfString.length; i++)
/* 133 */       this.params[i] = paramArrayOfString[i];
/*     */   }
/*     */ 
/*     */   public AgentConfigurationError(String paramString, Throwable paramThrowable, String[] paramArrayOfString)
/*     */   {
/* 138 */     super(paramThrowable);
/* 139 */     this.error = paramString;
/* 140 */     this.params = new String[paramArrayOfString.length];
/* 141 */     for (int i = 0; i < paramArrayOfString.length; i++)
/* 142 */       this.params[i] = paramArrayOfString[i];
/*     */   }
/*     */ 
 ...
 * Qualified Name:     sun.management.AgentConfigurationError
